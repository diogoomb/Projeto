...
var legendaPerRendaBaixaConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 67.16' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 56.7 a 67.16' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 39.26 a 56.7' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 21.81 a 39.26' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 4.37 a 21.81' + '<br>'
...
var legendaPerRendaMediaConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 88.19' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 77.81 a 88.19' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 60.49 a 77.81' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 43.18 a 60.49' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 25.86 a 43.18' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
...
var legendaPerRendaAltaConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 10.17' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 8.49 a 10.17' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 5.7 a 8.49' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 2.9 a 5.7' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.1 a 2.9' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
...
var legendaPerRendaBaixaFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 a 25' + '<br>'
...
var legendaPerRendaAltaFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 25.61' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 21.34 a 25.61' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 14.23 a 21.34' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 7.11 a 14.23' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 a 7.11' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' 0' + '<br>'
...
var legendaVarArrendadosConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-5.05 a 0]' + '<br>'
...
var legendaVarMenos100Conc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-51.32 a -40]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar200Conc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-22.82 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar400Conc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]80 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]60 a 80]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [44.08 a 60]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarArrendadosConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [4.17 a 10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMenos100Conc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]> -30' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-40 a -30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-50 a -40]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-63.04 a -50]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar200Conc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-31.09 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar400Conc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-8.71 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar650Conc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-64.71 a -30]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMenos100Freg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' Cálculo não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar400Freg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-33.34 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Cálculo não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
