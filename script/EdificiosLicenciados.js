...
////////////////////////////////////----------- TOTAL Edifícios licenciados 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minTotalEdificiosConc21 = 99999;
var maxTotalEdificiosConc21 = 0;
function estiloTotalEdificiosConc21(feature, latlng) {
    if(feature.properties.Edi_T_Ob21< minTotalEdificiosConc21 || feature.properties.Edi_T_Ob21 ===0){
        minTotalEdificiosConc21 = feature.properties.Edi_T_Ob21
    }
    if(feature.properties.Edi_T_Ob21> maxTotalEdificiosConc21){
        maxTotalEdificiosConc21 = feature.properties.Edi_T_Ob21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Ob21,1.8)
    });
}
...
function onEachFeatureTotalEdificiosConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios licenciados: ' + '<b>' +feature.properties.Edi_T_Ob21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
var TotalEdificiosConc21= L.geoJSON(dadosAbsolutosConcelhos,{
...
var slideTotalEdificiosConc21 = function(){
    ...
    sliderTotalEdificiosConc21.noUiSlider.on('update',function(e){
        TotalEdificiosConc21.eachLayer(function(layer){
            if(layer.feature.properties.Edi_T_Ob21>=parseFloat(e[0])&& layer.feature.properties.Edi_T_Ob21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
...
///////////////////////////-------------  FIM TOTAL Edifícios licenciados 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\


////////////////////////////////////----------- TOTAL Edificios CONSTRUÇÃO NOVA Licenciados 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minEdificiosConsNovaConc21 = 99999;
var maxEdificiosConsNovaConc21 = 0;
function estiloEdificiosConsNovaConc21(feature, latlng) {
    if(feature.properties.Edi_T_Co21< minEdificiosConsNovaConc21 || feature.properties.Edi_T_Co21 ===0){
        minEdificiosConsNovaConc21 = feature.properties.Edi_T_Co21
    }
    if(feature.properties.Edi_T_Co21> maxEdificiosConsNovaConc21){
        maxEdificiosConsNovaConc21 = feature.properties.Edi_T_Co21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Co21,1.8)
    });
}
function apagarEdificiosConsNovaConc21(e){
    var layer = e.target;
    EdificiosConsNovaConc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureEdificiosConsNovaConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios licenciados: ' + '<b>' +feature.properties.Edi_T_Co21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarEdificiosConsNovaConc21,
    })
};

var EdificiosConsNovaConc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloEdificiosConsNovaConc21,
    onEachFeature: onEachFeatureEdificiosConsNovaConc21,
});

var slideEdificiosConsNovaConc21 = function(){
    var sliderEdificiosConsNovaConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderEdificiosConsNovaConc21, {
        start: [minEdificiosConsNovaConc21, maxEdificiosConsNovaConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minEdificiosConsNovaConc21,
            'max': maxEdificiosConsNovaConc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minEdificiosConsNovaConc21);
    inputNumberMax.setAttribute("value",maxEdificiosConsNovaConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderEdificiosConsNovaConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderEdificiosConsNovaConc21.noUiSlider.set([null, this.value]);
    });

    sliderEdificiosConsNovaConc21.noUiSlider.on('update',function(e){
        EdificiosConsNovaConc21.eachLayer(function(layer){
            if(layer.feature.properties.Edi_T_Co21>=parseFloat(e[0])&& layer.feature.properties.Edi_T_Co21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderEdificiosConsNovaConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderEdificiosConsNovaConc21.noUiSlider;
    $(slidersGeral).append(sliderEdificiosConsNovaConc21);
}

///////////////////////////-------------  FIM TOTAL Edificios CONSTRUÇÃO NOVA Licenciados 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL Edificios AMPLIAÇÕES Licenciados 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minEdificiosAmpliacoesConc21 = 99999;
var maxEdificiosAmpliacoesConc21 = 0;
function estiloEdificiosAmpliacoesConc21(feature, latlng) {
    if(feature.properties.Edi_T_Am21< minEdificiosAmpliacoesConc21 || feature.properties.Edi_T_Am21 ===0){
        minEdificiosAmpliacoesConc21 = feature.properties.Edi_T_Am21
    }
    if(feature.properties.Edi_T_Am21> maxEdificiosAmpliacoesConc21){
        maxEdificiosAmpliacoesConc21 = feature.properties.Edi_T_Am21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Am21,1.8)
    });
}
function apagarEdificiosAmpliacoesConc21(e){
    var layer = e.target;
    EdificiosAmpliacoesConc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureEdificiosAmpliacoesConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios licenciados: ' + '<b>' +feature.properties.Edi_T_Am21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarEdificiosAmpliacoesConc21,
    })
};

var EdificiosAmpliacoesConc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloEdificiosAmpliacoesConc21,
    onEachFeature: onEachFeatureEdificiosAmpliacoesConc21,
});

var slideEdificiosAmpliacoesConc21 = function(){
    var sliderEdificiosAmpliacoesConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderEdificiosAmpliacoesConc21, {
        start: [minEdificiosAmpliacoesConc21, maxEdificiosAmpliacoesConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minEdificiosAmpliacoesConc21,
            'max': maxEdificiosAmpliacoesConc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minEdificiosAmpliacoesConc21);
    inputNumberMax.setAttribute("value",maxEdificiosAmpliacoesConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderEdificiosAmpliacoesConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderEdificiosAmpliacoesConc21.noUiSlider.set([null, this.value]);
    });

    sliderEdificiosAmpliacoesConc21.noUiSlider.on('update',function(e){
        EdificiosAmpliacoesConc21.eachLayer(function(layer){
            if(layer.feature.properties.Edi_T_Am21>=parseFloat(e[0])&& layer.feature.properties.Edi_T_Am21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderEdificiosAmpliacoesConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderEdificiosAmpliacoesConc21.noUiSlider;
    $(slidersGeral).append(sliderEdificiosAmpliacoesConc21);
}

///////////////////////////-------------  FIM TOTAL Edificios AMPLIAÇÕES Licenciados 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\
...
var legendaPerConsNovaConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 91.94' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 79.85 a 91.94' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 59.7 a 79.85' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 39.55 a 59.7' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 19.40 a 39.55' + '<br>'
...
var legendaPerAmpliacaoConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 72.54' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 60.45 a 72.54' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 40.3 a 60.45' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 20.15 a 40.3' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 20.15' + '<br>'
...
//////////////////////////------- Percentagem Construção Nova Concelho em 2021-----////

var minPerConsNovaConc21 = 100;
var maxPerConsNovaConc21 = 0;

function EstiloPerConsNovaConc21(feature) {
    if(feature.properties.PerCons_21 <= minPerConsNovaConc21 || minPerConsNovaConc21 === 0){
        minPerConsNovaConc21 = feature.properties.PerCons_21
    }
    if(feature.properties.PerCons_21 >= maxPerConsNovaConc21 ){
        maxPerConsNovaConc21 = feature.properties.PerCons_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerConsNovaConc(feature.properties.PerCons_21)
    };
}
function apagarPerConsNovaConc21(e) {
    PerConsNovaConc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerConsNovaConc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de edifícios licenciados: ' + '<b>' + feature.properties.PerCons_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerConsNovaConc21,
    });
}
var PerConsNovaConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerConsNovaConc21,
    onEachFeature: onEachFeaturePerConsNovaConc21
});
let slidePerConsNovaConc21 = function(){
    var sliderPerConsNovaConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderPerConsNovaConc21, {
        start: [minPerConsNovaConc21, maxPerConsNovaConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerConsNovaConc21,
            'max': maxPerConsNovaConc21
        },
        });
    inputNumberMin.setAttribute("value",minPerConsNovaConc21);
    inputNumberMax.setAttribute("value",maxPerConsNovaConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerConsNovaConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerConsNovaConc21.noUiSlider.set([null, this.value]);
    });

    sliderPerConsNovaConc21.noUiSlider.on('update',function(e){
        PerConsNovaConc21.eachLayer(function(layer){
            if(layer.feature.properties.PerCons_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerCons_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerConsNovaConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderPerConsNovaConc21.noUiSlider;
    $(slidersGeral).append(sliderPerConsNovaConc21);
} 

/////////////////////////////// Fim da Construção Nova Concelho em 2021 -------------- \\\\\\

///////////////////////////------- Percentagem Ampliações Concelho em 2021-----////

var minPerAmpliacoesConc21 = 100;
var maxPerAmpliacoesConc21 = 0;

function EstiloPerAmpliacoesConc21(feature) {
    if(feature.properties.PerAmpl_21 <= minPerAmpliacoesConc21 ){
        minPerAmpliacoesConc21 = feature.properties.PerAmpl_21
    }
    if(feature.properties.PerAmpl_21 >= maxPerAmpliacoesConc21 ){
        maxPerAmpliacoesConc21 = feature.properties.PerAmpl_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerAmpliacaoConc(feature.properties.PerAmpl_21)
    };
}
function apagarPerAmpliacoesConc21(e) {
    PerAmpliacoesConc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerAmpliacoesConc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de edifícios licenciados: ' + '<b>' + feature.properties.PerAmpl_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerAmpliacoesConc21,
    });
}
var PerAmpliacoesConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerAmpliacoesConc21,
    onEachFeature: onEachFeaturePerAmpliacoesConc21
});
let slidePerAmpliacoesConc21 = function(){
    var sliderPerAmpliacoesConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderPerAmpliacoesConc21, {
        start: [minPerAmpliacoesConc21, maxPerAmpliacoesConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerAmpliacoesConc21,
            'max': maxPerAmpliacoesConc21
        },
        });
    inputNumberMin.setAttribute("value",minPerAmpliacoesConc21);
    inputNumberMax.setAttribute("value",maxPerAmpliacoesConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerAmpliacoesConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerAmpliacoesConc21.noUiSlider.set([null, this.value]);
    });

    sliderPerAmpliacoesConc21.noUiSlider.on('update',function(e){
        PerAmpliacoesConc21.eachLayer(function(layer){
            if(layer.feature.properties.PerAmpl_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerAmpl_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerAmpliacoesConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderPerAmpliacoesConc21.noUiSlider;
    $(slidersGeral).append(sliderPerAmpliacoesConc21);
} 

/////////////////////////////// Fim da PERCENTAGEM AMPLIAÇÕES CONCELHO em 2021 -------------- \\\\\\
...
var legendaVarTotalEdiConc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-55.41 a -25]' + '<br>'
...
var legendaVarTotalConsNovaConc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-37.14 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalEdiConc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-53.66 a -25]' + '<br>'
...
var legendaVarTotalEdiConc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-16.18 a 0]' + '<br>'
...
var legendaVarTotalConsNovaConc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-23.4 a 0]' + '<br>'
...
var legendaVarTotalEdiConc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-21.69 a 0]' + '<br>'
...
var legendaVarTotalConsNovaConc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-9.09 a 0]' + '<br>'
...
var legendaVarTotalAmpliacoesConc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 75' + '<br>'
...
var legendaVarTotalEdiConc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1.97 a 0]' + '<br>'
...
var legendaVarTotalConsNovaConc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-7.69 a 0]' + '<br>'
...
var legendaVarTotalAmpliacoesConc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-41.18 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
var legendaVarTotalEdiConc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-36.58 a -25]' + '<br>'
...
var legendaVarTotalConsNovaConc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-14.04 a 0]' + '<br>'
...
var legendaVarTotalAmpliacoesConc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-50 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-76.19 a -50]' + '<br>'
...
var minVarTotalEdiConc21 = 0;
var maxVarTotalEdiConc21 = 0;

function CorVarTotalEdiConc21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#ff5e6e' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalEdiConc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-45 a -25]' + '<br>'
...
function EstiloVarTotalEdiConc21(feature) {
    if(feature.properties.VarObra_21 <= minVarTotalEdiConc21 || minVarTotalEdiConc21 === 0){
        minVarTotalEdiConc21 = feature.properties.VarObra_21
    }
    if(feature.properties.VarObra_21 > maxVarTotalEdiConc21){
        maxVarTotalEdiConc21 = feature.properties.VarObra_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalEdiConc21_20(feature.properties.VarObra_21)};
    }


function apagarVarTotalEdiConc21(e) {
    VarTotalEdiConc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarTotalEdiConc21(feature, layer) {
    if (feature.properties.VarObra_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarObra_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarTotalEdiConc21,
    });
}
var VarTotalEdiConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarTotalEdiConc21,
    onEachFeature: onEachFeatureVarTotalEdiConc21
});

let slideVarTotalEdiConc21 = function(){
    var sliderVarTotalEdiConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarTotalEdiConc21, {
        start: [minVarTotalEdiConc21, maxVarTotalEdiConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarTotalEdiConc21,
            'max': maxVarTotalEdiConc21
        },
        });
    inputNumberMin.setAttribute("value",minVarTotalEdiConc21);
    inputNumberMax.setAttribute("value",maxVarTotalEdiConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarTotalEdiConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarTotalEdiConc21.noUiSlider.set([null, this.value]);
    });

    sliderVarTotalEdiConc21.noUiSlider.on('update',function(e){
        VarTotalEdiConc21.eachLayer(function(layer){
            if (layer.feature.properties.VarObra_21 == null){
                return false
            }
            if(layer.feature.properties.VarObra_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarObra_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarTotalEdiConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarTotalEdiConc21.noUiSlider;
    $(slidersGeral).append(sliderVarTotalEdiConc21);
} 

///////////////////////////// Fim VARIAÇÃO TOTAL, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação Construção Nova, em 2021, POR CONCELHOS -------------------////

var minVarConsNovaConc21 = 0;
var maxVarConsNovaConc21 = 0;

function CorVarTotalConsNovaConc21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#ff5e6e' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalConsNovaConc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados pelo tipo de obra: Construção nova, entre 2021 e 2020, por concelho.' + '</strong>')
...
function EstiloVarConsNovaConc21(feature) {
    if(feature.properties.VarCons_21 <= minVarConsNovaConc21 || minVarConsNovaConc21 === 0){
        minVarConsNovaConc21 = feature.properties.VarCons_21
    }
    if(feature.properties.VarCons_21 > maxVarConsNovaConc21){
        maxVarConsNovaConc21 = feature.properties.VarCons_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalConsNovaConc21_20(feature.properties.VarCons_21)};
    }


function apagarVarConsNovaConc21(e) {
    VarConsNovaConc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarConsNovaConc21(feature, layer) {
    if (feature.properties.VarCons_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarCons_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarConsNovaConc21,
    });
}
var VarConsNovaConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarConsNovaConc21,
    onEachFeature: onEachFeatureVarConsNovaConc21
});

let slideVarConsNovaConc21 = function(){
    var sliderVarConsNovaConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarConsNovaConc21, {
        start: [minVarConsNovaConc21, maxVarConsNovaConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarConsNovaConc21,
            'max': maxVarConsNovaConc21
        },
        });
    inputNumberMin.setAttribute("value",minVarConsNovaConc21);
    inputNumberMax.setAttribute("value",maxVarConsNovaConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarConsNovaConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarConsNovaConc21.noUiSlider.set([null, this.value]);
    });

    sliderVarConsNovaConc21.noUiSlider.on('update',function(e){
        VarConsNovaConc21.eachLayer(function(layer){
            if (layer.feature.properties.VarCons_21 == null){
                return false
            }
            if(layer.feature.properties.VarCons_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarCons_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarConsNovaConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarConsNovaConc21.noUiSlider;
    $(slidersGeral).append(sliderVarConsNovaConc21);
} 

///////////////////////////// Fim Variação Construção Nova, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação Ampliações, em 2021, POR CONCELHOS -------------------////

var minVarAmpliacoesConc21 = 0;
var maxVarAmpliacoesConc21 = 0;

function CorVarTotalAmpliacoesConc21_20(d) {
    return d == null ? '#808080' :
        d >= 75  ? '#de1f35' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalAmpliacoesConc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-33.33 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
function EstiloVarAmpliacoesConc21(feature) {
    if(feature.properties.VarAmpl_21 <= minVarAmpliacoesConc21 || minVarAmpliacoesConc21 === 0){
        minVarAmpliacoesConc21 = feature.properties.VarAmpl_21
    }
    if(feature.properties.VarAmpl_21 > maxVarAmpliacoesConc21){
        maxVarAmpliacoesConc21 = feature.properties.VarAmpl_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalAmpliacoesConc21_20(feature.properties.VarAmpl_21)};
    }


function apagarVarAmpliacoesConc21(e) {
    VarAmpliacoesConc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarAmpliacoesConc21(feature, layer) {
    if (feature.properties.VarAmpl_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarAmpl_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarAmpliacoesConc21,
    });
}
var VarAmpliacoesConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarAmpliacoesConc21,
    onEachFeature: onEachFeatureVarAmpliacoesConc21
});

let slideVarAmpliacoesConc21 = function(){
    var sliderVarAmpliacoesConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarAmpliacoesConc21, {
        start: [minVarAmpliacoesConc21, maxVarAmpliacoesConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarAmpliacoesConc21,
            'max': maxVarAmpliacoesConc21
        },
        });
    inputNumberMin.setAttribute("value",minVarAmpliacoesConc21);
    inputNumberMax.setAttribute("value",maxVarAmpliacoesConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarAmpliacoesConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarAmpliacoesConc21.noUiSlider.set([null, this.value]);
    });

    sliderVarAmpliacoesConc21.noUiSlider.on('update',function(e){
        VarAmpliacoesConc21.eachLayer(function(layer){
            if (layer.feature.properties.VarAmpl_21 == null){
                return false
            }
            if(layer.feature.properties.VarAmpl_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarAmpl_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarAmpliacoesConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarAmpliacoesConc21.noUiSlider;
    $(slidersGeral).append(sliderVarAmpliacoesConc21);
} 

///////////////////////////// Fim Variação Ampliações, em 2021 , POR CONCELHOS -------------- \\\\\
...
////////////////////////////----------- TOTAL Edificios LICENCIAADOS 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minTotalEdificiosFreg21 = 99999;
var maxTotalEdificiosFreg21 = 0;
function estiloTotalEdificiosFreg21(feature, latlng) {
    if(feature.properties.Edi_T_Ob21< minTotalEdificiosFreg21 || feature.properties.Edi_T_Ob21 ===0){
        minTotalEdificiosFreg21 = feature.properties.Edi_T_Ob21
    }
    if(feature.properties.Edi_T_Ob21> maxTotalEdificiosFreg21){
        maxTotalEdificiosFreg21 = feature.properties.Edi_T_Ob21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Ob21,2)
    });
}
...
function onEachFeatureTotalEdificiosFreg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de edifícios licenciados: '  + '<b>'+ feature.properties.Edi_T_Ob21+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
var TotalEdificiosFreg21= L.geoJSON(dadosAbsolutosFreguesias,{
...
///////////////////////////---------- FIM TOTAL Edifícios licenciados EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- Edificios Licenciados Construção Nova 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minEdificiosConsNovaFreg21 = 99999;
var maxEdificiosConsNovaFreg21 = 0;
function estiloEdificiosConsNovaFreg21(feature, latlng) {
    if(feature.properties.Edi_T_Co21< minEdificiosConsNovaFreg21 || feature.properties.Edi_T_Co21 ===0){
        minEdificiosConsNovaFreg21 = feature.properties.Edi_T_Co21
    }
    if(feature.properties.Edi_T_Co21> maxEdificiosConsNovaFreg21){
        maxEdificiosConsNovaFreg21 = feature.properties.Edi_T_Co21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Co21,2)
    });
}
function apagarEdificiosConsNovaFreg21(e){
    var layer = e.target;
    EdificiosConsNovaFreg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureEdificiosConsNovaFreg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de edifícios licenciados: '  + '<b>'+ feature.properties.Edi_T_Co21+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarEdificiosConsNovaFreg21,
    })
};

var EdificiosConsNovaFreg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloEdificiosConsNovaFreg21,
    onEachFeature: onEachFeatureEdificiosConsNovaFreg21,
});

var slideEdificiosConsNovaFreg21 = function(){
    var sliderEdificiosConsNovaFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderEdificiosConsNovaFreg21, {
        start: [minEdificiosConsNovaFreg21, maxEdificiosConsNovaFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minEdificiosConsNovaFreg21,
            'max': maxEdificiosConsNovaFreg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minEdificiosConsNovaFreg21);
    inputNumberMax.setAttribute("value",maxEdificiosConsNovaFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderEdificiosConsNovaFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderEdificiosConsNovaFreg21.noUiSlider.set([null, this.value]);
    });

    sliderEdificiosConsNovaFreg21.noUiSlider.on('update',function(e){
        EdificiosConsNovaFreg21.eachLayer(function(layer){
            if(layer.feature.properties.Edi_T_Co21>=parseFloat(e[0])&& layer.feature.properties.Edi_T_Co21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderEdificiosConsNovaFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderEdificiosConsNovaFreg21.noUiSlider;
    $(slidersGeral).append(sliderEdificiosConsNovaFreg21);
}
///////////////////////////---------- FIM Edifícios licenciados CONSTRUÇÃO NOVA EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- Edificios Licenciados Ampliacoes 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minEdificiosAmpliacoesFreg21 = 99999;
var maxEdificiosAmpliacoesFreg21 = 0;
function estiloEdificiosAmpliacoesFreg21(feature, latlng) {
    if(feature.properties.Edi_T_Am21< minEdificiosAmpliacoesFreg21 || feature.properties.Edi_T_Am21 ===0){
        minEdificiosAmpliacoesFreg21 = feature.properties.Edi_T_Am21
    }
    if(feature.properties.Edi_T_Am21> maxEdificiosAmpliacoesFreg21){
        maxEdificiosAmpliacoesFreg21 = feature.properties.Edi_T_Am21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Edi_T_Am21,2)
    });
}
function apagarEdificiosAmpliacoesFreg21(e){
    var layer = e.target;
    EdificiosAmpliacoesFreg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureEdificiosAmpliacoesFreg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de edifícios licenciados: '  + '<b>'+ feature.properties.Edi_T_Am21+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarEdificiosAmpliacoesFreg21,
    })
};

var EdificiosAmpliacoesFreg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloEdificiosAmpliacoesFreg21,
    onEachFeature: onEachFeatureEdificiosAmpliacoesFreg21,
});

var slideEdificiosAmpliacoesFreg21 = function(){
    var sliderEdificiosAmpliacoesFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderEdificiosAmpliacoesFreg21, {
        start: [minEdificiosAmpliacoesFreg21, maxEdificiosAmpliacoesFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minEdificiosAmpliacoesFreg21,
            'max': maxEdificiosAmpliacoesFreg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minEdificiosAmpliacoesFreg21);
    inputNumberMax.setAttribute("value",maxEdificiosAmpliacoesFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderEdificiosAmpliacoesFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderEdificiosAmpliacoesFreg21.noUiSlider.set([null, this.value]);
    });

    sliderEdificiosAmpliacoesFreg21.noUiSlider.on('update',function(e){
        EdificiosAmpliacoesFreg21.eachLayer(function(layer){
            if(layer.feature.properties.Edi_T_Am21>=parseFloat(e[0])&& layer.feature.properties.Edi_T_Am21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderEdificiosAmpliacoesFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderEdificiosAmpliacoesFreg21.noUiSlider;
    $(slidersGeral).append(sliderEdificiosAmpliacoesFreg21);
}
///////////////////////////---------- FIM Edificios AMPLIAÇÕES Licenciados EM 2021,Por Freguesia -----------\\\\\\\
...
////////////////////////////////////----------- PERCENTAGEM CONSTRUÇÃO NOVA, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerConsFreg21 = 99999;
var maxPerConsFreg21 = 0;
function estiloPerConsFreg21(feature) {
    if(feature.properties.PerCons_21< minPerConsFreg21  && feature.properties.PerCons_21 > null|| feature.properties.PerCons_21 ===0){
        minPerConsFreg21 = feature.properties.PerCons_21
    }
    if(feature.properties.PerCons_21> maxPerConsFreg21 && feature.properties.PerCons_21 > null){
        maxPerConsFreg21 = feature.properties.PerCons_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerAmpliacaoFreg(feature.properties.PerCons_21)
    };
}
function apagarPerConsFreg21(e){
    var layer = e.target;
    PerConsFreg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerConsFreg21(feature, layer) {
    if (feature.properties.PerCons_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de edifícios licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de edifícios licenciados: ' + '<b>' +feature.properties.PerCons_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerConsFreg21,
    })
};

var PerConsFreg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerConsFreg21,
    onEachFeature: onEachFeaturePerConsFreg21,
});

var slidePerConsFreg21 = function(){
    var sliderPerConsFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderPerConsFreg21, {
        start: [minPerConsFreg21, maxPerConsFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerConsFreg21,
            'max': maxPerConsFreg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minPerConsFreg21);
    inputNumberMax.setAttribute("value",maxPerConsFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerConsFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerConsFreg21.noUiSlider.set([null, this.value]);
    });

    sliderPerConsFreg21.noUiSlider.on('update',function(e){
        PerConsFreg21.eachLayer(function(layer){
            if (layer.feature.properties.PerCons_21 == null){
                return false
            }
            if(layer.feature.properties.PerCons_21>=parseFloat(e[0])&& layer.feature.properties.PerCons_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerConsFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderPerConsFreg21.noUiSlider;
    $(slidersGeral).append(sliderPerConsFreg21);
}
///////////////////////////-------------------- Fim FREGUESIA CONSTRUÇÃO NOVA, EM 2021,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- PERCENTAGEM AMPLIACOES, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerAmplFreg21 = 99999;
var maxPerAmplFreg21 = 0;
function estiloPerAmplFreg21(feature) {
    if(feature.properties.PerAmpl_21< minPerAmplFreg21  && feature.properties.PerAmpl_21 > null|| feature.properties.PerAmpl_21 ===0){
        minPerAmplFreg21 = feature.properties.PerAmpl_21
    }
    if(feature.properties.PerAmpl_21> maxPerAmplFreg21 && feature.properties.PerAmpl_21 > null){
        maxPerAmplFreg21 = feature.properties.PerAmpl_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerAmpliacaoFreg(feature.properties.PerAmpl_21)
    };
}
function apagarPerAmplFreg21(e){
    var layer = e.target;
    PerAmplFreg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerAmplFreg21(feature, layer) {
    if (feature.properties.PerAmpl_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de edifícios licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de edifícios licenciados: ' + '<b>' +feature.properties.PerAmpl_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerAmplFreg21,
    })
};

var PerAmplFreg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerAmplFreg21,
    onEachFeature: onEachFeaturePerAmplFreg21,
});

var slidePerAmplFreg21 = function(){
    var sliderPerAmplFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderPerAmplFreg21, {
        start: [minPerAmplFreg21, maxPerAmplFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerAmplFreg21,
            'max': maxPerAmplFreg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minPerAmplFreg21);
    inputNumberMax.setAttribute("value",maxPerAmplFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerAmplFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerAmplFreg21.noUiSlider.set([null, this.value]);
    });

    sliderPerAmplFreg21.noUiSlider.on('update',function(e){
        PerAmplFreg21.eachLayer(function(layer){
            if (layer.feature.properties.PerAmpl_21 == null){
                return false
            }
            if(layer.feature.properties.PerAmpl_21>=parseFloat(e[0])&& layer.feature.properties.PerAmpl_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerAmplFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderPerAmplFreg21.noUiSlider;
    $(slidersGeral).append(sliderPerAmplFreg21);
}
///////////////////////////-------------------- FIM PERCENTAGEM AMPLIACOES, EM 2021,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\
...
var minVarTotalEdiFreg21 = 9999;
var maxVarTotalEdiFreg21 = 0;

function CorVarTotalEdiFreg21_20(d){
    return d == null ? '#808080' :
        d >= 100  ? '#ff5e6e' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalEdiFreg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarTotalEdiFreg21(feature) {
    if(feature.properties.VarObra_21 <= minVarTotalEdiFreg21){
        minVarTotalEdiFreg21 = feature.properties.VarObra_21
    }
    if(feature.properties.VarObra_21 > maxVarTotalEdiFreg21){
        maxVarTotalEdiFreg21 = feature.properties.VarObra_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalEdiFreg21_20(feature.properties.VarObra_21)};
    }


function apagarVarTotalEdiFreg21(e) {
    VarTotalEdiFreg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarTotalEdiFreg21(feature, layer) {
    if (feature.properties.VarObra_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarObra_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarTotalEdiFreg21,
    });
}
var VarTotalEdiFreg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarTotalEdiFreg21,
    onEachFeature: onEachFeatureVarTotalEdiFreg21
});

let slideVarTotalEdiFreg21 = function(){
    var sliderVarTotalEdiFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarTotalEdiFreg21, {
        start: [minVarTotalEdiFreg21, maxVarTotalEdiFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarTotalEdiFreg21,
            'max': maxVarTotalEdiFreg21
        },
        });
    inputNumberMin.setAttribute("value",minVarTotalEdiFreg21);
    inputNumberMax.setAttribute("value",maxVarTotalEdiFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarTotalEdiFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarTotalEdiFreg21.noUiSlider.set([null, this.value]);
    });

    sliderVarTotalEdiFreg21.noUiSlider.on('update',function(e){
        VarTotalEdiFreg21.eachLayer(function(layer){
            if (layer.feature.properties.VarObra_21 == null){
                return false
            }
            if(layer.feature.properties.VarObra_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarObra_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarTotalEdiFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarTotalEdiFreg21.noUiSlider;
    $(slidersGeral).append(sliderVarTotalEdiFreg21);
} 

///////////////////////////// Fim VARIAÇÃO TOTAL, em 2021 , POR FREGUESIAS -------------- \\\\\

/////////////////////////////------- Variação Construção Nova, em 2021, POR FREGUESIAS -------------------////

var minVarConsNovaFreg21 = 9999;
var maxVarConsNovaFreg21 = 0;

function CorVarTotalConsNovaFreg21_20(d){
    return d == null ? '#808080' :
        d >= 100  ? '#ff5e6e' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalConsNovaFreg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados pelo tipo de obra: Construção nova, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarConsNovaFreg21(feature) {
    if(feature.properties.VarCons_21 <= minVarConsNovaFreg21 ){
        minVarConsNovaFreg21 = feature.properties.VarCons_21
    }
    if(feature.properties.VarCons_21 > maxVarConsNovaFreg21 ){
        maxVarConsNovaFreg21 = feature.properties.VarCons_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalConsNovaFreg21_20(feature.properties.VarCons_21)};
    }


function apagarVarConsNovaFreg21(e) {
    VarConsNovaFreg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarConsNovaFreg21(feature, layer) {
    if (feature.properties.VarCons_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarCons_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarConsNovaFreg21,
    });
}
var VarConsNovaFreg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarConsNovaFreg21,
    onEachFeature: onEachFeatureVarConsNovaFreg21
});

let slideVarConsNovaFreg21 = function(){
    var sliderVarConsNovaFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarConsNovaFreg21, {
        start: [minVarConsNovaFreg21, maxVarConsNovaFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarConsNovaFreg21,
            'max': maxVarConsNovaFreg21
        },
        });
    inputNumberMin.setAttribute("value",minVarConsNovaFreg21);
    inputNumberMax.setAttribute("value",maxVarConsNovaFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarConsNovaFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarConsNovaFreg21.noUiSlider.set([null, this.value]);
    });

    sliderVarConsNovaFreg21.noUiSlider.on('update',function(e){
        VarConsNovaFreg21.eachLayer(function(layer){
            if (layer.feature.properties.VarCons_21 == null){
                return false
            }
            if(layer.feature.properties.VarCons_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarCons_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarConsNovaFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarConsNovaFreg21.noUiSlider;
    $(slidersGeral).append(sliderVarConsNovaFreg21);
} 

///////////////////////////// Fim Variação Construção Nova, em 2021 , POR FREGUESIAS -------------- \\\\\

/////////////////////////////------- Variação Ampliações, em 2021, POR FREGUESIAS -------------------////

var minVarAmpliacoesFreg21 = 9999;
var maxVarAmpliacoesFreg21 = 0;

function CorVarTotalAmpliacoesFreg21_20(d){
    return d == null ? '#808080' :
        d >= 100  ? '#ff5e6e' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalAmpliacoesFreg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do Total de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarAmpliacoesFreg21(feature) {
    if(feature.properties.VarAmpl_21 <= minVarAmpliacoesFreg21){
        minVarAmpliacoesFreg21 = feature.properties.VarAmpl_21
    }
    if(feature.properties.VarAmpl_21 > maxVarAmpliacoesFreg21){
        maxVarAmpliacoesFreg21 = feature.properties.VarAmpl_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalAmpliacoesFreg21_20(feature.properties.VarAmpl_21)};
    }


function apagarVarAmpliacoesFreg21(e) {
    VarAmpliacoesFreg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarAmpliacoesFreg21(feature, layer) {
    if (feature.properties.VarAmpl_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarAmpl_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarAmpliacoesFreg21,
    });
}
var VarAmpliacoesFreg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarAmpliacoesFreg21,
    onEachFeature: onEachFeatureVarAmpliacoesFreg21
});

let slideVarAmpliacoesFreg21 = function(){
    var sliderVarAmpliacoesFreg21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarAmpliacoesFreg21, {
        start: [minVarAmpliacoesFreg21, maxVarAmpliacoesFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarAmpliacoesFreg21,
            'max': maxVarAmpliacoesFreg21
        },
        });
    inputNumberMin.setAttribute("value",minVarAmpliacoesFreg21);
    inputNumberMax.setAttribute("value",maxVarAmpliacoesFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarAmpliacoesFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarAmpliacoesFreg21.noUiSlider.set([null, this.value]);
    });

    sliderVarAmpliacoesFreg21.noUiSlider.on('update',function(e){
        VarAmpliacoesFreg21.eachLayer(function(layer){
            if (layer.feature.properties.VarAmpl_21 == null){
                return false
            }
            if(layer.feature.properties.VarAmpl_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarAmpl_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarAmpliacoesFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    sliderAtivo = sliderVarAmpliacoesFreg21.noUiSlider;
    $(slidersGeral).append(sliderVarAmpliacoesFreg21);
} 

///////////////////////////// Fim Variação Ampliações, em 2021 , POR FREGUESIAS -------------- \\\\\
...
let novaLayer = function(layer){
    ...
    if (layer == TotalEdificiosConc21 && naoDuplicar != 193){
        $('#tituloMapa').html(' <strong>' + 'Total de edifícios licenciados, em 2021, por concelho.' + '</strong>')
        legenda(maxTotalEdificiosConc21, ((maxTotalEdificiosConc21-minTotalEdificiosConc21)/2).toFixed(0),minTotalEdificiosConc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideTotalEdificiosConc21();
        naoDuplicar = 193;
    }
    if (layer == EdificiosConsNovaConc21 && naoDuplicar != 194){
        $('#tituloMapa').html(' <strong>' + 'Número de edifícios licenciados pelo tipo de obra: Construção nova, em 2021, por concelho.' + '</strong>')
        legenda(maxEdificiosConsNovaConc21, ((maxEdificiosConsNovaConc21-minEdificiosConsNovaConc21)/2).toFixed(0),minEdificiosConsNovaConc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideEdificiosConsNovaConc21();
        naoDuplicar = 194;
    }
    if (layer == EdificiosAmpliacoesConc21 && naoDuplicar != 195){
        $('#tituloMapa').html(' <strong>' + 'Número de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021, por concelho.' + '</strong>')
        legenda(maxEdificiosAmpliacoesConc21, ((maxEdificiosAmpliacoesConc21-minEdificiosAmpliacoesConc21)/2).toFixed(0),minEdificiosAmpliacoesConc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideEdificiosAmpliacoesConc21();
        naoDuplicar = 195;
    }
    ...
    if (layer == PerConsNovaConc21 && naoDuplicar != 196){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios licenciados pelo tipo de obra: Construção nova, em 2021, por concelho.' + '</strong>')
        legendaPerConsNovaConc();
        slidePerConsNovaConc21();
        naoDuplicar = 196;
    }
    if (layer == PerAmpliacoesConc21 && naoDuplicar != 197){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021, por concelho.' + '</strong>');
        legendaPerAmpliacaoConc();
        slidePerAmpliacoesConc21();
        naoDuplicar = 197;
    }
    ...
    if (layer == VarTotalEdiConc21 && naoDuplicar != 198){
        legendaVarTotalEdiConc21_20();
        slideVarTotalEdiConc21();
        naoDuplicar = 198;
    }
    if (layer == VarConsNovaConc21 && naoDuplicar != 199){
        legendaVarTotalConsNovaConc21_20();
        slideVarConsNovaConc21();
        naoDuplicar = 199;
    }
    if (layer == VarAmpliacoesConc21 && naoDuplicar != 200){
        legendaVarTotalAmpliacoesConc21_20();
        slideVarAmpliacoesConc21();
        naoDuplicar = 200;
    }
    ...
    if (layer == TotalEdificiosFreg21 && naoDuplicar != 185){
        $('#tituloMapa').html(' <strong>' + 'Total de edifícios licenciados, em 2021, por freguesia.' + '</strong>')
        legenda(maxTotalEdificiosFreg21, ((maxTotalEdificiosFreg21-minTotalEdificiosFreg21)/2).toFixed(0),minTotalEdificiosFreg21,2);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideTotalEdificiosFreg21();
        naoDuplicar = 185;
    }
    if (layer == EdificiosConsNovaFreg21 && naoDuplicar != 186){
        $('#tituloMapa').html(' <strong>' + 'Número de edifícios licenciados pelo tipo de obra: Construção nova, em 2021, por freguesia.' + '</strong>')
        legenda(maxEdificiosConsNovaFreg21, ((maxEdificiosConsNovaFreg21-minEdificiosConsNovaFreg21)/2).toFixed(0),minEdificiosConsNovaFreg21,2);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideEdificiosConsNovaFreg21();
        naoDuplicar = 186;
    }
    if (layer == EdificiosAmpliacoesFreg21 && naoDuplicar != 187){
        $('#tituloMapa').html(' <strong>' + 'Número de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021, por freguesia.' + '</strong>')
        legenda(maxEdificiosAmpliacoesFreg21, ((maxEdificiosAmpliacoesFreg21-minEdificiosAmpliacoesFreg21)/2).toFixed(0),minEdificiosAmpliacoesFreg21,2);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideEdificiosAmpliacoesFreg21();
        naoDuplicar = 187;
    }
    ...
    if (layer == PerConsFreg21 && naoDuplicar != 188){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios licenciados pelo tipo de obra: Construção nova, em 2021, por freguesia.' + '</strong>');
        legendaPerAmpliacaoFreg();
        slidePerConsFreg21();
        naoDuplicar = 188;
    }
    if (layer == PerAmplFreg21 && naoDuplicar != 189){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios licenciados pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021, por freguesia.' + '</strong>');
        legendaPerAmpliacaoFreg();
        slidePerAmplFreg21();
        naoDuplicar = 189;
    }
    ...
    if (layer == VarTotalEdiFreg21 && naoDuplicar != 190){
        legendaVarTotalEdiFreg21_20();
        slideVarTotalEdiFreg21();
        naoDuplicar = 190;
    }
    if (layer == VarConsNovaFreg21 && naoDuplicar != 191){
        legendaVarTotalConsNovaFreg21_20();
        slideVarConsNovaFreg21();
        naoDuplicar = 191;
    }
    if (layer == VarAmpliacoesFreg21 && naoDuplicar != 192){
        legendaVarTotalAmpliacoesFreg21_20();
        slideVarAmpliacoesFreg21();
        naoDuplicar = 192;
    }
    layer.addTo(map);
    layerAtiva = layer;  
...
function myFunction() {
    ...
    if ($('#concelho').hasClass('active2')){
        if ($('#absoluto').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(EdificiosConsNovaConc21);
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(EdificiosAmpliacoesConc21);
            } 
        }
    if ($('#percentagem').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(PerConsNovaConc21)
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(PerAmpliacoesConc21)
            } 
        }
        if ($('#taxaVariacao').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(VarTotalEdiConc21)
            }
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(VarConsNovaConc21)
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(VarAmpliacoesConc21)
            }   
        }
    }
    if ($('#freguesias').hasClass('active2')){
        if ($('#absoluto').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(EdificiosConsNovaFreg21)
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(EdificiosAmpliacoesFreg21)
            } 
        }
        if ($('#percentagem').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(PerConsFreg21)
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(PerAmplFreg21)
            } 
        }
        if ($('#taxaVariacao').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(VarTotalEdiFreg21)
            }
            if (ano == "2021" && tipologia == "Construcao"){
                novaLayer(VarConsNovaFreg21)
            }
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(VarAmpliacoesFreg21)
            }  
        }
    }
}
...
var DadosAbsolutos = function(){
    $('#tituloMapa').html('Número de edifícios licenciados, segundo o tipo de obra, entre 2014 e 2021, Nº.');
        ...
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/EdificiosLicenciadosProv.json", function(data){
            ...
            $.each(data, function(key, value){
                ...
                if(containsAnyLetter(value.Freguesia)){
                    ...
                    dados += '<td class="bordertop">'+value.Dados2021.toLocaleString("fr")+'</td>';
                }
                else{
...
$('#tabelaPercentagem').click(function(){
    $('#tituloMapa').html('Proporção do número de edifícios licenciados, segundo o tipo de obra, entre 2014 e 2021, %.')
        $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/EdificiosLicenciadosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
...
$('#tabelaVariacao').click(function(){  
    $('#tituloMapa').html('Variação do número de edifícios licenciados, segundo o tipo de obra, entre 2014 e 2021, %.')
    $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/EdificiosLicenciadosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
