...
var legendaTaxaEsforco80mConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 31 a 37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 25 a 31' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 19 a 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 13 a 19' + '<br>'
...
var legendaTaxaEsforco100mConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 43' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 39 a 43' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 31 a 39' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 24 a 31' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 16 a 24' + '<br>'
...
var legendaTaxaEsforco80mFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 43 a 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 30 a 42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 16 a 29' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 3 a 15' + '<br>'
...
var legendaTaxaEsforco100mFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 58' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 49 a 57' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 34 a 48' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 19 a 33' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 4 a 18' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Cálculo não aplicável' + '<br>'
