...
var legendaPerPrecosVendasConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 2101' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 1836 a 2101' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 1394 a 1836' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 952 a 1394' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 511 a 952' + '<br>'
...
var legendaVar2Tri16_1Tri16Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-17.45 a -5]' + '<br>'
...
var legendaVar3Tri16_2Tri16Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 4' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-1.5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-3.96 a -1.5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri16_3Tri16Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-2 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-4.13 a -2]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri17_4Tri16Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-2 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-8.31 a -2]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri17_1Tri17Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1.34 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri17_2Tri17Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-7.13 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri17_3Tri17Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-0.73 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri18_4Tri17Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [0.11 a 1.5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri18_1Tri18Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 4.5' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]3 a 4.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]1.5 a 3]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 1.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1.61 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri18_3Tri18Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 6' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]4 a 6]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1.45 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri19_4Tri18Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-6.94 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri19_1Tri19Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-7.95 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri19_2Tri19Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 6' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]4 a 6]s' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1.95 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri19_3Tri19Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-2.63 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri20_4Tri19Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-2 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-3.63 a -2]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri20_2Tri20Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-1 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri20_3Tri20Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 5' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]3 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 3]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-6.62 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri21_4Tri20Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]3 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]1.5 a 3]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [0.74 a 1.5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri21_1Tri21Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 3' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 3]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]1 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]0 a 1]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-5.78 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri21_2Tri21Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 9' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]5 a 9]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-5.71 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri21_3Tri21Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-6.95 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPerPrecosVendasFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 2728' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 2295 a 2728' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 1574 a 2295' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 852 a 1574' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 131 a 852' + '<br>'
...
var legendaVar2Tri16_1Tri16Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]6 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]3 a 6]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 3]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-21.66 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri16_2Tri16Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-13.07 a -5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri16_3Tri16Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-19.57 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri17_4Tri16Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-11.03 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri17_1Tri17Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-26.59 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri17_2Tri17Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-17.97 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri17_3Tri17Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]5 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-18 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri18_4Tri17Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-18.6 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri18_1Tri18Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-29.32 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri18_2Tri18Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]5 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-22.59 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri18_3Tri18Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-32.83 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri19_4Tri18Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-26.32 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri19_1Tri19Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-25.71 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri19_2Tri19Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-29.76 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri19_3Tri19Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-24.53 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri20_4Tri19Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-15.2 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri20_1Tri20Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-30.7 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri20_2Tri20Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-17.23 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri20_3Tri20Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-27 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar1Tri21_4Tri20Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-27.46 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2Tri21_1Tri21Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-16.91 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar3Tri21_2Tri21Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-27.54 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar4Tri21_3Tri21Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2.5 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-16.61 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
let VariacaoCondicionantes = function(){
    ...
    if ($('#taxaVariacao').hasClass('active5') || $('#taxaVariacao').hasClass('active4')){
        ...
        if (ano == "2021"){
            $("#trimestres option[value='4']").remove();

        }
        if (ano != "2021"){
            if ($("#trimestres option[value='4']").length == 0){
                $('#trimestres').append("<option value='4'>4º - 3º</option>");
    ...
    if ($('#percentagem').hasClass('active5') || $('#percentagem').hasClass('active4')){
        ...
        if (ano != "2021"){
            if ($("#trimestres option[value='4']").length == 0){
                $('#trimestres').append("<option value='4'>4º</option>");
            }   
        }
    }
}
...
$('#opcaoTabela').click(function(){
    ...
    $('#tabelaPercentagem').attr("class","butao active1");
    DadosAbsolutos();
