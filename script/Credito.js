...
var legendaPerCredito = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 20000' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 15000 a 20000' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 10000 a 15000' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 5000 a 10000' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 1420 a 5000' + '<br>'
...
var legendaVar2001_2000 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.48 a 13]' + '<br>'
...
var legendaVar2003_2002 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [1.42 a 10' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2004_2003 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-2.47 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2005_2004 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]5 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-15.15 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2006_2005 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-14.63 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2008_2007 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-20.44 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2009_2008 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-3.79 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2010_2009 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-9.58 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2012_2011 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-7.44 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2013_2012 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-24.25 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2014_2013 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-58.23 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2015_2014 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-21.9 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2016_2015 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-10 a -5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-15 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-19.2 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2017_2016 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-15.14 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2018_2017 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-9.12 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2019_2018 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-5.67 a -2.5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2020_2019 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-9.74 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
