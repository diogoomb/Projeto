...
////////////////////////////////////----------- TOTAL EDIFICIOS CONCLUIDOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureTotalEdificiosConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios concluídos: ' + '<b>' +feature.properties.Edi_T_Ob21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
///////////////////////////-------------  FIM TOTAL EDIFICIOS CONCLUIDOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\


////////////////////////////////////----------- Total Edificios Construção Nova concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureEdificiosConsNovaConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios concluídos: ' + '<b>' +feature.properties.Edi_T_Co21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
///////////////////////////-------------  FIM Total Edificios Construção Nova concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- Total Edificios Ampliação concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minEdificiosAmpliacaoConc21 = 99999;
var maxEdificiosAmpliacaoConc21 = 0;
function estiloEdificiosAmpliacaoConc21(feature, latlng) {
    if(feature.properties.Edi_T_Am21< minEdificiosAmpliacaoConc21 || feature.properties.Edi_T_Am21 ===0){
        minEdificiosAmpliacaoConc21 = feature.properties.Edi_T_Am21
    }
    if(feature.properties.Edi_T_Am21> maxEdificiosAmpliacaoConc21){
        maxEdificiosAmpliacaoConc21 = feature.properties.Edi_T_Am21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
...
function apagarEdificiosAmpliacaoConc21(e){
    var layer = e.target;
    EdificiosAmpliacaoConc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureEdificiosAmpliacaoConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Edifícios concluídos: ' + '<b>' +feature.properties.Edi_T_Am21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarEdificiosAmpliacaoConc21,
    })
};

var EdificiosAmpliacaoConc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloEdificiosAmpliacaoConc21,
    onEachFeature: onEachFeatureEdificiosAmpliacaoConc21,
});

var slideEdificiosAmpliacaoConc21 = function(){
    var sliderEdificiosAmpliacaoConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderEdificiosAmpliacaoConc21, {
        start: [minEdificiosAmpliacaoConc21, maxEdificiosAmpliacaoConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minEdificiosAmpliacaoConc21,
            'max': maxEdificiosAmpliacaoConc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minEdificiosAmpliacaoConc21);
    inputNumberMax.setAttribute("value",maxEdificiosAmpliacaoConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderEdificiosAmpliacaoConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderEdificiosAmpliacaoConc21.noUiSlider.set([null, this.value]);
    });

    sliderEdificiosAmpliacaoConc21.noUiSlider.on('update',function(e){
        EdificiosAmpliacaoConc21.eachLayer(function(layer){
    ...
    sliderEdificiosAmpliacaoConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 94;
    sliderAtivo = sliderEdificiosAmpliacaoConc21.noUiSlider;
    $(slidersGeral).append(sliderEdificiosAmpliacaoConc21);
}

///////////////////////////-------------  FIM Total Edificios Ampliação concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\
...
function EstiloPerConsNovaConc21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerAmpliacoesConc(feature.properties.PerCons_21)
    };
}
...
function onEachFeaturePerConsNovaConc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de edifícios concluídos: ' + '<b>' + feature.properties.PerCons_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
/////////////////////////////// Fim Percentagem Construção NOVA CONCELHO em 2021 -------------- \\\\\\

///////////////////////////------- Percentagem Ampliação CONCELHO em 2021-----////

var minPerAmpliacaoConc21 = 100;
var maxPerAmpliacaoConc21 = 0;

function EstiloPerAmpliacaoConc21(feature) {
    if(feature.properties.PerAmpl_21 <= minPerAmpliacaoConc21 ){
        minPerAmpliacaoConc21 = feature.properties.PerAmpl_21
    }
    if(feature.properties.PerAmpl_21 >= maxPerAmpliacaoConc21 ){
        maxPerAmpliacaoConc21 = feature.properties.PerAmpl_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerAmpliacoesConc(feature.properties.PerAmpl_21)
    };
}
function apagarPerAmpliacaoConc21(e) {
    PerAmpliacaoConc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerAmpliacaoConc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de edifícios concluídos: ' + '<b>' + feature.properties.PerAmpl_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerAmpliacaoConc21,
    });
}
var PerAmpliacaoConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerAmpliacaoConc21,
    onEachFeature: onEachFeaturePerAmpliacaoConc21
});
let slidePerAmpliacaoConc21 = function(){
    var sliderPerAmpliacaoConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderPerAmpliacaoConc21, {
        start: [minPerAmpliacaoConc21, maxPerAmpliacaoConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerAmpliacaoConc21,
            'max': maxPerAmpliacaoConc21
        },
        });
    inputNumberMin.setAttribute("value",minPerAmpliacaoConc21);
    inputNumberMax.setAttribute("value",maxPerAmpliacaoConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerAmpliacaoConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerAmpliacaoConc21.noUiSlider.set([null, this.value]);
    });

    sliderPerAmpliacaoConc21.noUiSlider.on('update',function(e){
        PerAmpliacaoConc21.eachLayer(function(layer){
        ...
        sliderPerAmpliacaoConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 96;
    sliderAtivo = sliderPerAmpliacaoConc21.noUiSlider;
    $(slidersGeral).append(sliderPerAmpliacaoConc21);
} 

/////////////////////////////// Fim Percentagem AMPLIAÇÃO CONCELHO em 2021 -------------- \\\\\\
...
var legendaVarAmpliacoes15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-85.71 a -50]' + '<br>'
...
var legendaVarConsNova16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 30' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-50 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-78.57 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
var legendaVarAmpliacoes16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]30 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
...
var legendaVarTotalEdi17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-47.06 a -25]' + '<br>'
...
var legendaVarConsNova17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-53.85 a -25]' + '<br>'
...
var legendaVarAmpliacoes17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 75' + '<br>'
...
var legendaVarTotalEdi18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-22.73 a 0]' + '<br>'
...
var legendaVarConsNova18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-61.54 a -50]' + '<br>'
...
var legendaVarTotalEdi19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-26.92 a -25]' + '<br>'
...
var legendaVarConsNova19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-23.53 a 0]' + '<br>'
...
var legendaVarTotalEdi20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-63.94 a -25]' + '<br>'
...
var legendaVarAmpliacoes20_19 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de edifícios concluídos pelo tipo de obra: Ampliações, alterações e reconstruções, entre 2020 e 2019, por concelho.' + '</strong>')
...
function CorVarTotalEdi21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#ff5e6e' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalEdi21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de edifícios concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-31.03 a -15]' + '<br>'
...
function EstiloVarTotalConc21(feature) {
    if(feature.properties.VarObra_21 <= minVarTotalConc21 || minVarTotalConc21 === 0){
        minVarTotalConc21 = feature.properties.VarObra_21
    }
    if(feature.properties.VarObra_21 > maxVarTotalConc21){
        maxVarTotalConc21 = feature.properties.VarObra_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalEdi21_20(feature.properties.VarObra_21)};
    }
...
/////////////////////////////------- Variaçao Construção, em 2021, POR CONCELHOS -------------------////

var minVarConstrucaoConc21 = 0;
var maxVarConstrucaoConc21 = 0;

function CorVarConsNova21_20(d) {
    return d == null ? '#808080' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
        d >= -15  ? '#ced4ea' :
...
var legendaVarConsNova21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de edifícios concluídos pelo tipo de obra: Construção nova, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-36 a -15]' + '<br>'
...
function EstiloVarConstrucaoConc21(feature) {
    if(feature.properties.VarCons_21 <= minVarConstrucaoConc21){
        minVarConstrucaoConc21 = feature.properties.VarCons_21
    }
    if(feature.properties.VarCons_21 > maxVarConstrucaoConc21){
        maxVarConstrucaoConc21 = feature.properties.VarCons_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarConsNova21_20(feature.properties.VarCons_21)};
    }


function apagarVarConstrucaoConc21(e) {
    VarConstrucaoConc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarConstrucaoConc21(feature, layer) {
    ...
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarConstrucaoConc21,
    });
}
var VarConstrucaoConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarConstrucaoConc21,
    onEachFeature: onEachFeatureVarConstrucaoConc21
});

let slideVarConstrucaoConc21 = function(){
    var sliderVarConstrucaoConc21 = document.querySelector('.sliderAtivo');
    ...
    noUiSlider.create(sliderVarConstrucaoConc21, {
        start: [minVarConstrucaoConc21, maxVarConstrucaoConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarConstrucaoConc21,
            'max': maxVarConstrucaoConc21
        },
        });
    inputNumberMin.setAttribute("value",minVarConstrucaoConc21);
    inputNumberMax.setAttribute("value",maxVarConstrucaoConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarConstrucaoConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarConstrucaoConc21.noUiSlider.set([null, this.value]);
    });

    sliderVarConstrucaoConc21.noUiSlider.on('update',function(e){
        VarConstrucaoConc21.eachLayer(function(layer){
        ...
        sliderVarConstrucaoConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 98;
    sliderAtivo = sliderVarConstrucaoConc21.noUiSlider;
    $(slidersGeral).append(sliderVarConstrucaoConc21);
} 

///////////////////////////// Fim Variaçao Construção, em 2021 , POR CONCELHOS -------------- \\\\\
...
function CorVarAmpliacoes21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#de1f35' :
        d >= 0  ? '#fbcec6' :
        d >= -25  ? '#ced4ea' :
...
var legendaVarAmpliacoes21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de edifícios concluídos pelo tipo de obra: Ampliações, alterações e reconstruções, entre 2021 e 2020, por concelho.' + '</strong>')
...
function EstiloVarAmpliacoesConc21(feature) {
    if(feature.properties.VarAmpl_21 <= minVarAmpliacoesConc21){
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarAmpliacoes21_20(feature.properties.VarAmpl_21)};
    }
...
let novaLayer = function(layer){
    ...
    if (layer == TotalEdificiosConc21 && naoDuplicar != 92){
        $('#tituloMapa').html(' <strong>' + 'Total de edifícios concluídos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == EdificiosConsNovaConc21 && naoDuplicar != 93){
        $('#tituloMapa').html(' <strong>' + 'Total de edifícios concluídos pelo tipo de obra: Construção nova, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == EdificiosAmpliacaoConc21 && naoDuplicar != 94){
        $('#tituloMapa').html(' <strong>' + 'Total de edifícios concluídos pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021, por concelho.' + '</strong>');
        legenda(maxEdificiosAmpliacaoConc21, ((maxEdificiosAmpliacaoConc21-minEdificiosAmpliacaoConc21)/2).toFixed(0),minEdificiosAmpliacaoConc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideEdificiosAmpliacaoConc21();
        naoDuplicar = 94;
    }
    ...
    if (layer == PerConsNovaConc21 && naoDuplicar != 95){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios concluídos pelo tipo de obra: Construção nova em 2021.' + '</strong>');
        legendaPercentagensConc();
        slidePerConsNovaConc21();
        naoDuplicar = 95;
    }
    if (layer == PerAmpliacaoConc21 && naoDuplicar != 96){
        $('#tituloMapa').html(' <strong>' + 'Proporção de edifícios concluídos pelo tipo de obra: Ampliações, alterações e reconstruções, em 2021.' + '</strong>');
        legendaPercentagensConc();
        slidePerAmpliacaoConc21();
        naoDuplicar = 96;
    }
    ...
    if (layer == VarTotalConc21 && naoDuplicar != 97){
        legendaVarTotalEdi21_20();
        slideVarTotalConc21();
        naoDuplicar = 97;
    }
    if (layer == VarConstrucaoConc21 && naoDuplicar != 98){
        legendaVarConsNova21_20();
        slideVarConstrucaoConc21();
        naoDuplicar = 98;
    }
    if (layer == VarAmpliacoesConc21 && naoDuplicar != 99){
        legendaVarAmpliacoes21_20();
    ...
    if ($('#concelho').hasClass('active2')){
        if ($('#absoluto').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Ampliacao"){
                novaLayer(EdificiosAmpliacaoConc21);
            } 
        }
...
var DadosAbsolutos = function(){
    $('#tituloMapa').html('Número de edifícios concluídos, segundo o tipo de obra, entre 2014 e 2021, Nº.');
...
$('#tabelaPercentagem').click(function(){
    $('#tituloMapa').html('Proporção do número de edifícios concluídos, segundo o tipo de obra, entre 2014 e 2021, %.')
        $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/EdificiosConcluidosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
...
$('#tabelaVariacao').click(function(){  
    $('#tituloMapa').html('Variação do número de edifícios concluídos, segundo o tipo de obra, entre 2014 e 2021, %.')
    $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/EdificiosConcluidosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
