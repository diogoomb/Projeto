...
var legendaVar09_08 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 8' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-3.94 a 0]' + '<br>'
...
var legendaVar10_09 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-15.38 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar11_10 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-14.1 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar12_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-17.09 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar13_12 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-13 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar14_13 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-10.63 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-10 a -5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-14.34 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]5 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-3.58 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]10 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-2.91 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]35 a 40]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 35]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [19.63 a 25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]10 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [1.63 a 10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVar21_20 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]5 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [0.8 a 5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
