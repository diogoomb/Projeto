...
var legendaPerNenhumConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 29.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 26.13 - 29.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 21.15 - 26.13' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 16.17 - 21.15' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 11.19 - 16.17' + '<br>'
...
var legendaPerBasicoConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 61.91' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 57.92 - 61.91' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 51.27 - 57.92' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 44.61 - 51.27' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 37.96 - 44.61' + '<br>'
...
var legendaPerSecundarioConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 21.32' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 18.76 - 21.32' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 14.5 - 18.76' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 10.23 - 14.5' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 5.97 - 10.23' + '<br>'
...
var legendaPerSuperiorConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 29.10' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 24.65 - 29.10' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 17.25 - 24.65' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 9.84 - 17.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 2.43 - 9.84' + '<br>'
...
var legendaVarNenhumConc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-36.89 a -30]' + '<br>'
...
var legendaVarNenhumConc21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]> -24' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-30 a -24]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-33 a -30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-36.84 a -33]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarBasicoConc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 2.5' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2.5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-11.58 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarBasicoConc21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]> -13' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-15 a -13]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-17 a -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-24.95 a -17]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarSecundarioConc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]13 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]11 a 13]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.54 a 11]' + '<br>'
...
var legendaVarSecundarioConc21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 22' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]20 a 22]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]18 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [16.66 a 18]' + '<br>'
...
var legendaVarSuperiorConc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 16' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]12 a 16]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]8 a 12]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [5.72 a 8]' + '<br>'
...
var legendaVarSuperiorConc21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]18 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]12 a 18]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.62 a 12]' + '<br>'
...
var legendaPerNenhumFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 48.91' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 42.42 - 48.91' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 31.62 - 42.42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 20.81 - 31.62' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 10 - 20.81' + '<br>'
...
var legendaPerBasicoFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 67.79' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 61.74 - 67.79' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 51.65 - 61.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 41.55 - 51.65' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 31.46 - 41.55' + '<br>'
...
var legendaPerSecundarioFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 23.18' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 19.59 - 23.18' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 13.6 - 19.59' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 7.60 - 13.6' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 1.61 - 7.60' + '<br>'
...
var legendaPerSuperiorFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 36.34' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 30.38 - 36.34' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 20.46 - 30.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 10.53 - 20.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.6 - 10.53' + '<br>'
...
var legendaVarNenhumFreg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 10' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-57.84 a -40]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarNenhumFreg21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-20 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]-30 a -20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-40 a -30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-56.94 a -40]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarBasicoFreg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-36.45 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarBasicoFreg21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-36.68 a -30]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarSecundarioFreg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 80' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]40 a 80]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 40]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-20 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-43.51 a -20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8");
...
var legendaVarSecundarioFreg21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [11.26 a 30]' + '<br>'
...
var legendaVarSuperiorFreg21 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [11.43 a 25]' + '<br>'
...
$('#tituloMapa').html('<strong>' + 'Número de residentes sem algum nível de ensino, em 2001, por concelho.' + '</strong>')
...
let novaLayer = function(layer){
    ...
    if (layer == TotalNenhumConcelhos11 && naoDuplicar != 2){
        $('#tituloMapa').html('<strong>' + 'Número de residentes sem algum nível de ensino, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == TotalNenhumConcelhos21 && naoDuplicar != 3){
        $('#tituloMapa').html('<strong>' + 'Número de residentes sem algum nível de ensino, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == TotalBasicoConcelhos01 && naoDuplicar != 4){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino básico, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == TotalBasicoConcelhos11 && naoDuplicar != 5){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino básico, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == TotalBasicoConcelhos21 && naoDuplicar != 6){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino básico, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == TotalSecundarioConcelhos01 && naoDuplicar != 7){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino secundário, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == TotalSecundarioConcelhos11 && naoDuplicar != 8){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino secundário, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == TotalSecundarioConcelhos21 && naoDuplicar != 9){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino secundário, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == TotalSuperiorConcelhos01 && naoDuplicar != 10){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino superior, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == TotalSuperiorConcelhos11 && naoDuplicar != 11){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino superior, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == TotalSuperiorConcelhos21 && naoDuplicar != 12){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com ensino superior, em 2021, por concelho.' + '</strong>');
