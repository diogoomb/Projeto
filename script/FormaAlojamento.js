...
var legendaPerConcelhoRH = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 85.11' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 80.97 - 85.11' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 74.05 - 80.97' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 67.14 - 74.05' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 60.22 - 67.14' + '<br>'
...
var legendaPerConcelhoRS = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 27.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 23.81 - 27.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 17.27 - 23.81' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 10.72 - 17.27' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 4.16 - 10.72' + '<br>'
...
var legendaPerConcelhoVago = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 17.55' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 15.64 - 17.55' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 12.46 - 15.64' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 9.28 - 12.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 6.1 - 9.28' + '<br>'
...
var legendaVarRH21_11Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]5 a 8]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-0.37 a 0]' + '<br>'
...
var legendaVarRH11_01Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [2.89 a 5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRH01_91Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-19.35 a 0]' + '<br>'
...
var legendaVarRS21_11Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-39.62 a -20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRS11_01Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]10 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-3.35 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRS01_91Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]60 a 70]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-5.63 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' -sem informação disponível' + '<br>'
...
var legendaVarVagos21_11Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-26.7 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarVagos11_01Concelho = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-32.02 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPerFreguesiaRH = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 87.99' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 79.83 - 87.99' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 66.23 - 79.83' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 52.62 - 66.23' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 39.02 - 52.62' + '<br>'
...
var legendaPerFreguesiaRS = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 44.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 36.94 - 44.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 24.74 - 36.94' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 12.55 - 24.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.35 - 12.55' + '<br>'
...
var legendaPerFreguesiaVago = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 27.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 22.93 - 27.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 15.38 - 22.93' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 7.82 - 15.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.26 - 7.82' + '<br>'
...
var legendaVarRH21_11Freguesia = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-21.95 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRH11_01Freguesia = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-24.23 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRS21_11Freguesia = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-60.16 a -40]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarRS11_01Freguesia = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-20 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-47.22 a -20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarVagos21_11Freguesia = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-53.35 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
