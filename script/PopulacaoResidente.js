...
legenda('Nº de residentes',maxTotalPopResiCon91, (maxTotalPopResiCon91-minTotalPopResiCon91)/2,minTotalPopResiCon91,0.1);
...
var legendaVariacaoConc91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-4 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-14 a -4]' + '<br>'
...
var legendaVariacaoConc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-2.5 a 0]' + '<br>'
...
var legendaVariacaoFreg91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-42 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.9")
...
var legendaVariacaoFreg01 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>")
    $('#tituloMapa').html(' <strong>' + 'Variação da população residente entre 2011 e 2001, por freguesia.' + '</strong>')
...
var legendaVariacaoFreg11 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>")
    $('#tituloMapa').html(' <strong>' + 'Variação da população residente entre 2021 e 2011, por freguesia.' + '</strong>')
...
$('#tituloMapa').html(' <strong>' + 'Número de residentes em 1991, por concelho.' + '</strong>')
...
let novaLayer = function(layer){
    ...
    if (layer == TotalPopResiCon01 && naoDuplicar != 2){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2001, por concelho.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiCon01,((maxTotalPopResiCon01-minTotalPopResiCon01)/2).toFixed(0),minTotalPopResiCon01,0.1);
        contorno.addTo(map)
        baseAtiva = contorno;
    ...
    if (layer == TotalPopResiCon11 && naoDuplicar != 3){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2011, por concelho.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiCon11,((maxTotalPopResiCon11-minTotalPopResiCon11)/2).toFixed(0),minTotalPopResiCon11,0.1);
        contorno.addTo(map)
        baseAtiva = contorno;
    ...
    if (layer == TotalPopResiCon21 && naoDuplicar != 4){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2021, por concelho.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiCon21,((maxTotalPopResiCon21-minTotalPopResiCon21)/2).toFixed(0),minTotalPopResiCon21,0.1);
        contorno.addTo(map)
        baseAtiva = contorno;
    ...
    if (layer == TotalPopResiFreg91 && naoDuplicar != 8){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 1991, por freguesia.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiFreg91,((maxTotalPopResiFreg91-minTotalPopResiFreg91)/2).toFixed(0),minTotalPopResiFreg91,0.1);
    ...
    if (layer == TotalPopResiFreg01 && naoDuplicar != 9){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2001, por freguesia.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiFreg01,((maxTotalPopResiFreg01-minTotalPopResiFreg01)/2).toFixed(0),minTotalPopResiFreg01,0.1);
        contornoFreg2001.addTo(map)
        baseAtiva = contornoFreg2001;
    ...
    if (layer == TotalPopResiFreg11 && naoDuplicar != 10){
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2011, por freguesia.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiFreg11,((maxTotalPopResiFreg11-minTotalPopResiFreg11)/2).toFixed(0),minTotalPopResiFreg11,0.1);
        ...
        $('#tituloMapa').html(' <strong>' + 'Número de residentes em 2021, por freguesia.' + '</strong>')
        legenda('Nº de residentes',maxTotalPopResiFreg21,((maxTotalPopResiFreg21-minTotalPopResiFreg21)/2).toFixed(0),minTotalPopResiFreg21,0.1);
        contornoFreg.addTo(map)
        baseAtiva = contornoFreg;
