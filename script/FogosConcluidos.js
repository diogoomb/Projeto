...
var minTotalFogosConc14 = 0;
var maxTotalFogosConc14 = 0;
function estiloTotalFogosConc14(feature, latlng) {
    if(feature.properties.Fog_CTot14 < minTotalFogosConc14){
...
////////////////////////////////////----------- TOTAL FOGOS concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minTotalFogosConc21 = 99999;
var maxTotalFogosConc21 = 0;
function estiloTotalFogosConc21(feature, latlng) {
    if(feature.properties.Fog_CTot21< minTotalFogosConc21 || feature.properties.Fog_CTot21 ===0){
        minTotalFogosConc21 = feature.properties.Fog_CTot21
    }
    if(feature.properties.Fog_CTot21> maxTotalFogosConc21){
        maxTotalFogosConc21 = feature.properties.Fog_CTot21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_CTot21,1.8)
    });
}
...
function onEachFeatureTotalFogosConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos concluídos: ' + '<b>' +feature.properties.Fog_CTot21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
var slideTotalFogosConc21 = function(){
    ...
    sliderTotalFogosConc21.noUiSlider.on('update',function(e){
        TotalFogosConc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_CTot21>=parseFloat(e[0])&& layer.feature.properties.Fog_CTot21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
...
///////////////////////////-------------  FIM TOTAL FOGOS concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\


////////////////////////////////////----------- TOTAL FOGOS T1 concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureFogosT1Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T0 ou T1 concluídos: ' + '<b>' +feature.properties.Fog_T121 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
///////////////////////////-------------  FIM TOTAL FOGOS T1 concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T2 concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureFogosT2Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T2 concluídos: ' + '<b>' +feature.properties.Fog_T221 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
///////////////////////////-------------  FIM TOTAL FOGOS T2 concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T3 concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureFogosT3Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T3 concluídos: ' + '<b>' +feature.properties.Fog_T321 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
///////////////////////////-------------  FIM TOTAL FOGOS T3 concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T4 concluídos 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\
...
function onEachFeatureFogosT4Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T4 ou mais concluídos: ' + '<b>' +feature.properties.Fog_T421 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
/////////////////////////-------------  FIM TOTAL FOGOS T4 concluídos 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\
...
var legendaPerT1Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 53.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 44.48 a 53.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 29.66 a 44.48' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 14.83 a 29.66' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 14.83' + '<br>'
...
var legendaPerT2Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 65.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 54.38 a 65.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 36.25 a 54.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 18.13 a 36.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 18.13' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
var legendaPerT3Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 80.09' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 68.41 a 80.09' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 48.94 a 68.41' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 29.47 a 48.94' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 10 a 29.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
var legendaPerT4Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 56.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 46.88 a 56.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 31.25 a 46.88' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 15.53 a 31.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 15.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
function EstiloPerT1Conc21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerT1Conc(feature.properties.PerT1_21)
    };
}
...
function onEachFeaturePerT1Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T0 ou T1 concluídos: ' + '<b>' + feature.properties.PerT1_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
function EstiloPerT2Conc21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerT2Conc(feature.properties.PerT2_21)
    };
}
...
function onEachFeaturePerT2Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T2 concluídos: ' + '<b>' + feature.properties.PerT2_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
function onEachFeaturePerT3Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T3 concluídos: ' + '<b>' + feature.properties.PerT3_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
function EstiloPerT4Conc21(feature) {
    ...
    return {
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerT4Conc(feature.properties.PerT4_21)
    };
}
...
function onEachFeaturePerT4Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T4 ou mais concluídos: ' + '<b>' + feature.properties.PerT4_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
var legendaVarTotalConc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]> 0' + '<br>'
...
var legendaVarT4Conc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]> 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-50 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-100 a -50]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-65.38 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT2Conc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' [-73.33 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-50 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-66.33 a -50]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT1Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-75 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-100 a -75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT2Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-75 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-100 a -75]' + '<br>'
...
var legendaVarT3Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-75 a -40]' + '<br>'
...
var legendaVarTotalConc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-61.54 a -15]' + '<br>'
...
var legendaVarT1Conc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]75 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#0b2c40"></i>' + ' [-100 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT3Conc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-66.67 a -50]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT4Conc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-100 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-100 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT2Conc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-75 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-100 a -75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT4Conc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' [-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' [-100 a -50]' + '<br>'
...
var legendaVarTotalConc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-33.33 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc21_20 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-30 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-67.57 a -30]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
function onEachFeatureVarTotalConc21(feature, layer) {
    if (feature.properties.VarTot_21 == null){
        ...
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarTot_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
var legendaVarT1Conc21_20 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T0 ou T1 concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-84.78 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
function EstiloVarT1Conc21(feature) {
    if(feature.properties.VarT1_21 <= minVarT1Conc21 || minVarT1Conc21 === 0){
...
function onEachFeatureVarT1Conc21(feature, layer) {
    if (feature.properties.VarT1_21 == null){
        ...
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT1_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
var legendaVarT2Conc21_20 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T2 concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-77.78 a -50]' + '<br>'
...
function onEachFeatureVarT2Conc21(feature, layer) {
    if (feature.properties.VarT2_21 == null){
        ...
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT2_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
var legendaVarT3Conc21_20 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T3 concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]30 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-65.98 a -25]' + '<br>'
...
function EstiloVarT3Conc21(feature) {
    if(feature.properties.VarT3_21 <= minVarT3Conc21 || minVarT3Conc21 === 0){
...
function onEachFeatureVarT3Conc21(feature, layer) {
    if (feature.properties.VarT3_21 == null){
        ...
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT3_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
var legendaVarT4Conc21_20 = function() {
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T4 ou mais concluídos, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' [-75 a -25]' + '<br>'
...
function onEachFeatureVarT4Conc21(feature, layer) {
    if (feature.properties.VarT4_21 == null){
        ...
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT4_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
...
let novaLayer = function(layer){
    ...
    if (layer == TotalFogosConc21 && naoDuplicar != 94){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos concluídos, em 2021, por concelho.' + '</strong>');
        legenda(maxTotalFogosConc21, ((maxTotalFogosConc21-minTotalFogosConc21)/2).toFixed(0),minTotalFogosConc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideTotalFogosConc21();
        naoDuplicar = 94;
    }
    if (layer == FogosT1Conc21 && naoDuplicar != 95){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T0 ou T1 concluídos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == FogosT2Conc21 && naoDuplicar != 96){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T2 concluídos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == FogosT3Conc21 && naoDuplicar != 97){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T3 concluídos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == FogosT4Conc21 && naoDuplicar != 98){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T4 concluídos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == PerT1Conc21 && naoDuplicar != 99){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T0 ou T1 concluídos, em 2021, por concelho.' + '</strong>');
        legendaPerT1Conc()
        slidePerT1Conc21();
        naoDuplicar = 99;
    }
    if (layer == PerT2Conc21 && naoDuplicar != 100){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T2 concluídos, em 2021, por concelho.' + '</strong>');
        legendaPerT2Conc()
        slidePerT2Conc21();
        naoDuplicar = 100;
    }
    if (layer == PerT3Conc21 && naoDuplicar != 101){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T3 concluídos, em 2021, por concelho.' + '</strong>');
        legendaPerT3Conc()
        slidePerT3Conc21();
        naoDuplicar = 101;
    }
    if (layer == PerT4Conc21 && naoDuplicar != 102){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T4 ou mais concluídos, em 2021, por concelho.' + '</strong>');
        legendaPerT4Conc()
        slidePerT4Conc21();
        naoDuplicar = 102;
    }
    ...
    if (layer == VarTotalConc21 && naoDuplicar != 103){
        legendaVarTotalConc21_20();
        slideVarTotalConc21();
        naoDuplicar = 103;
    }
    if (layer == VarT1Conc21 && naoDuplicar != 104){
        legendaVarT1Conc21_20();
        slideVarT1Conc21();
        naoDuplicar = 104;
    }
    if (layer == VarT2Conc21 && naoDuplicar != 105){
        legendaVarT2Conc21_20();
        slideVarT2Conc21();
        naoDuplicar = 105;
    }
    if (layer == VarT3Conc21 && naoDuplicar != 106){
        legendaVarT3Conc21_20();
        slideVarT3Conc21();
        naoDuplicar = 106;
    }
    if (layer == VarT4Conc21 && naoDuplicar != 107){
...
var DadosAbsolutos = function(){
    $('#tituloMapa').html('Número de fogos concluídos, segundo a tipologia, entre 2014 e 2021, Nº.');
...
$('#tabelaPercentagem').click(function(){
    $('#tituloMapa').html('Proporção do número de fogos concluídos, segundo a tipologia, entre 2014 e 2021, %.')
        $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/FogosConcluidosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
...
$('#tabelaVariacao').click(function(){  
    $('#tituloMapa').html('Variação do número de fogos concluídos, segundo a tipologia, entre 2014 e 2021, %.')
    $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/FogosConcluidosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
