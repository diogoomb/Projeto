...
var btns1 = opcoesTabela.getElementsByClassName("butao");
...
////////////////////////////////////----------- TOTAL FOGOS LICENCIADOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minTotalFogosConc21 = 99999;
var maxTotalFogosConc21 = 0;
function estiloTotalFogosConc21(feature, latlng) {
    if(feature.properties.Fog_LTot21< minTotalFogosConc21 || feature.properties.Fog_LTot21 ===0){
        minTotalFogosConc21 = feature.properties.Fog_LTot21
    }
    if(feature.properties.Fog_LTot21> maxTotalFogosConc21){
        maxTotalFogosConc21 = feature.properties.Fog_LTot21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_LTot21,1.3)
    });
}
function apagarTotalFogosConc21(e){
    var layer = e.target;
    TotalFogosConc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureTotalFogosConc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos licenciados: ' + '<b>' +feature.properties.Fog_LTot21 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarTotalFogosConc21,
    })
};

var TotalFogosConc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloTotalFogosConc21,
    onEachFeature: onEachFeatureTotalFogosConc21,
});

var slideTotalFogosConc21 = function(){
    var sliderTotalFogosConc21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 187){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderTotalFogosConc21, {
        start: [minTotalFogosConc21, maxTotalFogosConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minTotalFogosConc21,
            'max': maxTotalFogosConc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minTotalFogosConc21);
    inputNumberMax.setAttribute("value",maxTotalFogosConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderTotalFogosConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderTotalFogosConc21.noUiSlider.set([null, this.value]);
    });

    sliderTotalFogosConc21.noUiSlider.on('update',function(e){
        TotalFogosConc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_LTot21>=parseFloat(e[0])&& layer.feature.properties.Fog_LTot21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderTotalFogosConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 187;
    sliderAtivo = sliderTotalFogosConc21.noUiSlider;
    $(slidersGeral).append(sliderTotalFogosConc21);
}

///////////////////////////-------------  FIM TOTAL FOGOS LICENCIADOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\


////////////////////////////////////----------- TOTAL FOGOS T1 LICENCIADOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minFogosT1Conc21 = 99999;
var maxFogosT1Conc21 = 0;
function estiloFogosT1Conc21(feature, latlng) {
    if(feature.properties.Fog_T121< minFogosT1Conc21 || feature.properties.Fog_T121 ===0){
        minFogosT1Conc21 = feature.properties.Fog_T121
    }
    if(feature.properties.Fog_T121> maxFogosT1Conc21){
        maxFogosT1Conc21 = feature.properties.Fog_T121
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T121,1.8)
    });
}
function apagarFogosT1Conc21(e){
    var layer = e.target;
    FogosT1Conc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT1Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T0 ou T1 licenciados: ' + '<b>' +feature.properties.Fog_T121 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT1Conc21,
    })
};

var FogosT1Conc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloFogosT1Conc21,
    onEachFeature: onEachFeatureFogosT1Conc21,
});

var slideFogosT1Conc21 = function(){
    var sliderFogosT1Conc21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 188){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT1Conc21, {
        start: [minFogosT1Conc21, maxFogosT1Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT1Conc21,
            'max': maxFogosT1Conc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT1Conc21);
    inputNumberMax.setAttribute("value",maxFogosT1Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT1Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT1Conc21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT1Conc21.noUiSlider.on('update',function(e){
        FogosT1Conc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T121>=parseFloat(e[0])&& layer.feature.properties.Fog_T121 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderFogosT1Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 188;
    sliderAtivo = sliderFogosT1Conc21.noUiSlider;
    $(slidersGeral).append(sliderFogosT1Conc21);
}

///////////////////////////-------------  FIM TOTAL FOGOS T1 LICENCIADOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T2 LICENCIADOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minFogosT2Conc21 = 99999;
var maxFogosT2Conc21 = 0;
function estiloFogosT2Conc21(feature, latlng) {
    if(feature.properties.Fog_T221< minFogosT2Conc21 || feature.properties.Fog_T221 ===0){
        minFogosT2Conc21 = feature.properties.Fog_T221
    }
    if(feature.properties.Fog_T221> maxFogosT2Conc21){
        maxFogosT2Conc21 = feature.properties.Fog_T221
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T221,1.8)
    });
}
function apagarFogosT2Conc21(e){
    var layer = e.target;
    FogosT2Conc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT2Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T2 licenciados: ' + '<b>' +feature.properties.Fog_T221 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT2Conc21,
    })
};

var FogosT2Conc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloFogosT2Conc21,
    onEachFeature: onEachFeatureFogosT2Conc21,
});

var slideFogosT2Conc21 = function(){
    var sliderFogosT2Conc21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 189){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT2Conc21, {
        start: [minFogosT2Conc21, maxFogosT2Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT2Conc21,
            'max': maxFogosT2Conc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT2Conc21);
    inputNumberMax.setAttribute("value",maxFogosT2Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT2Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT2Conc21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT2Conc21.noUiSlider.on('update',function(e){
        FogosT2Conc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T221>=parseFloat(e[0])&& layer.feature.properties.Fog_T221 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderFogosT2Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 189;
    sliderAtivo = sliderFogosT2Conc21.noUiSlider;
    $(slidersGeral).append(sliderFogosT2Conc21);
}

///////////////////////////-------------  FIM TOTAL FOGOS T2 LICENCIADOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T3 LICENCIADOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minFogosT3Conc21 = 99999;
var maxFogosT3Conc21 = 0;
function estiloFogosT3Conc21(feature, latlng) {
    if(feature.properties.Fog_T321< minFogosT3Conc21 || feature.properties.Fog_T321 ===0){
        minFogosT3Conc21 = feature.properties.Fog_T321
    }
    if(feature.properties.Fog_T321> maxFogosT3Conc21){
        maxFogosT3Conc21 = feature.properties.Fog_T321
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T321,1.8)
    });
}
function apagarFogosT3Conc21(e){
    var layer = e.target;
    FogosT3Conc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT3Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T3 licenciados: ' + '<b>' +feature.properties.Fog_T321 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT3Conc21,
    })
};

var FogosT3Conc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloFogosT3Conc21,
    onEachFeature: onEachFeatureFogosT3Conc21,
});

var slideFogosT3Conc21 = function(){
    var sliderFogosT3Conc21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 190){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT3Conc21, {
        start: [minFogosT3Conc21, maxFogosT3Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT3Conc21,
            'max': maxFogosT3Conc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT3Conc21);
    inputNumberMax.setAttribute("value",maxFogosT3Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT3Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT3Conc21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT3Conc21.noUiSlider.on('update',function(e){
        FogosT3Conc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T321>=parseFloat(e[0])&& layer.feature.properties.Fog_T321 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderFogosT3Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 190;
    sliderAtivo = sliderFogosT3Conc21.noUiSlider;
    $(slidersGeral).append(sliderFogosT3Conc21);
}

///////////////////////////-------------  FIM TOTAL FOGOS T3 LICENCIADOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- TOTAL FOGOS T4 LICENCIADOS 2021, POR CONCELHO ------------------------------\\\\\\\\\\\\\

var minFogosT4Conc21 = 99999;
var maxFogosT4Conc21 = 0;
function estiloFogosT4Conc21(feature, latlng) {
    if(feature.properties.Fog_T421< minFogosT4Conc21 || feature.properties.Fog_T421 ===0){
        minFogosT4Conc21 = feature.properties.Fog_T421
    }
    if(feature.properties.Fog_T421> maxFogosT4Conc21){
        maxFogosT4Conc21 = feature.properties.Fog_T421
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T421,1.8)
    });
}
function apagarFogosT4Conc21(e){
    var layer = e.target;
    FogosT4Conc21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT4Conc21(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Fogos T4 ou mais licenciados: ' + '<b>' +feature.properties.Fog_T421 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT4Conc21,
    })
};

var FogosT4Conc21= L.geoJSON(dadosAbsolutosConcelhos,{
    pointToLayer:estiloFogosT4Conc21,
    onEachFeature: onEachFeatureFogosT4Conc21,
});

var slideFogosT4Conc21 = function(){
    var sliderFogosT4Conc21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 191){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT4Conc21, {
        start: [minFogosT4Conc21, maxFogosT4Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT4Conc21,
            'max': maxFogosT4Conc21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT4Conc21);
    inputNumberMax.setAttribute("value",maxFogosT4Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT4Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT4Conc21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT4Conc21.noUiSlider.on('update',function(e){
        FogosT4Conc21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T421>=parseFloat(e[0])&& layer.feature.properties.Fog_T421 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderFogosT4Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 191;
    sliderAtivo = sliderFogosT4Conc21.noUiSlider;
    $(slidersGeral).append(sliderFogosT4Conc21);
}

/////////////////////////-------------  FIM TOTAL FOGOS T4 LICENCIADOS 2021, POR CONCELHO -----------\\\\\\\\\\\\\\\\\\\\\\
...
var legendaPerT1Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 55.66' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 46.38 a 55.66' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 30.92 a 46.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 15.46 a 30.92' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 15.46' + '<br>'
...
var legendaPerT2Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 46.8' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 39 a 46.8' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 26 a 39' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 13 a 26' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 13' + '<br>'
...
var legendaPerT3Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 91.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 77.8 a 91.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 55.59 a 77.8' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 33.39 a 55.59' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 11.18 a 33.39' + '<br>'
...
var legendaPerT4Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 48.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 40.39 a 48.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 26.93 a 40.39' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 13.46 a 26.93' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 13.46' + '<br>'
...
//////////////////////////------- Percentagem T1 CONCELHO em 2021-----////

var minPerT1Conc21 = 100;
var maxPerT1Conc21 = 0;

function EstiloPerT1Conc21(feature) {
    if(feature.properties.PerT1_21 <= minPerT1Conc21){
        minPerT1Conc21 = feature.properties.PerT1_21
    }
    if(feature.properties.PerT1_21 >= maxPerT1Conc21 ){
        maxPerT1Conc21 = feature.properties.PerT1_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerPerT1Conc(feature.properties.PerT1_21)
    };
}
function apagarPerT1Conc21(e) {
    PerT1Conc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerT1Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T0 ou T1 licenciados: ' + '<b>' + feature.properties.PerT1_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerT1Conc21,
    });
}
var PerT1Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerT1Conc21,
    onEachFeature: onEachFeaturePerT1Conc21
});
let slidePerT1Conc21 = function(){
    var sliderPerT1Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 192){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderPerT1Conc21, {
        start: [minPerT1Conc21, maxPerT1Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT1Conc21,
    ...
    inputNumberMin.setAttribute("value",minPerT1Conc21);
    inputNumberMax.setAttribute("value",maxPerT1Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT1Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT1Conc21.noUiSlider.set([null, this.value]);
    });

    sliderPerT1Conc21.noUiSlider.on('update',function(e){
        PerT1Conc21.eachLayer(function(layer){
            if(layer.feature.properties.PerT1_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerT1_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerT1Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 192;
    sliderAtivo = sliderPerT1Conc21.noUiSlider;
    $(slidersGeral).append(sliderPerT1Conc21);
} 

/////////////////////////////// Fim da T1 CONCELHO em 2021 -------------- \\\\\\

///////////////////////////------- Percentagem T2 CONCELHO em 2021-----////

var minPerT2Conc21 = 100;
var maxPerT2Conc21 = 0;

function EstiloPerT2Conc21(feature) {
    if(feature.properties.PerT2_21 <= minPerT2Conc21){
        minPerT2Conc21 = feature.properties.PerT2_21
    }
    if(feature.properties.PerT2_21 >= maxPerT2Conc21 ){
        maxPerT2Conc21 = feature.properties.PerT2_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerPerT2Conc(feature.properties.PerT2_21)
    };
}
function apagarPerT2Conc21(e) {
    PerT2Conc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerT2Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T2 licenciados: ' + '<b>' + feature.properties.PerT2_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerT2Conc21,
    });
}
var PerT2Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerT2Conc21,
    onEachFeature: onEachFeaturePerT2Conc21
});
let slidePerT2Conc21 = function(){
    var sliderPerT2Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 193){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderPerT2Conc21, {
        start: [minPerT2Conc21, maxPerT2Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT2Conc21,
    ...
    inputNumberMin.setAttribute("value",minPerT2Conc21);
    inputNumberMax.setAttribute("value",maxPerT2Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT2Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT2Conc21.noUiSlider.set([null, this.value]);
    });

    sliderPerT2Conc21.noUiSlider.on('update',function(e){
        PerT2Conc21.eachLayer(function(layer){
            if(layer.feature.properties.PerT2_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerT2_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerT2Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 193;
    sliderAtivo = sliderPerT2Conc21.noUiSlider;
    $(slidersGeral).append(sliderPerT2Conc21);
} 

/////////////////////////////// Fim da T2 CONCELHO em 2021 -------------- \\\\\\

///////////////////////////------- Percentagem T3 CONCELHO em 2021-----////

var minPerT3Conc21 = 100;
var maxPerT3Conc21 = 0;

function EstiloPerT3Conc21(feature) {
    if(feature.properties.PerT3_21 <= minPerT3Conc21){
        minPerT3Conc21 = feature.properties.PerT3_21
    }
    if(feature.properties.PerT3_21 >= maxPerT3Conc21 ){
        maxPerT3Conc21 = feature.properties.PerT3_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerT3Conc(feature.properties.PerT3_21)
    };
}
function apagarPerT3Conc21(e) {
    PerT3Conc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerT3Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T3 licenciados: ' + '<b>' + feature.properties.PerT3_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerT3Conc21,
    });
}
var PerT3Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerT3Conc21,
    onEachFeature: onEachFeaturePerT3Conc21
});
let slidePerT3Conc21 = function(){
    var sliderPerT3Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 194){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderPerT3Conc21, {
        start: [minPerT3Conc21, maxPerT3Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT3Conc21,
    ...
    inputNumberMin.setAttribute("value",minPerT3Conc21);
    inputNumberMax.setAttribute("value",maxPerT3Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT3Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT3Conc21.noUiSlider.set([null, this.value]);
    });

    sliderPerT3Conc21.noUiSlider.on('update',function(e){
        PerT3Conc21.eachLayer(function(layer){
            if(layer.feature.properties.PerT3_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerT3_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerT3Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 194;
    sliderAtivo = sliderPerT3Conc21.noUiSlider;
    $(slidersGeral).append(sliderPerT3Conc21);
} 

/////////////////////////////// Fim de T3 CONCELHO em 2021 -------------- \\\\\\

///////////////////////////------- Percentagem T4 CONCELHO em 2021-----////

var minPerT4Conc21 = 100;
var maxPerT4Conc21 = 0;

function EstiloPerT4Conc21(feature) {
    if(feature.properties.PerT4_21 <= minPerT4Conc21){
        minPerT4Conc21 = feature.properties.PerT4_21
    }
    if(feature.properties.PerT4_21 >= maxPerT4Conc21 ){
        maxPerT4Conc21 = feature.properties.PerT4_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerPerT4Conc(feature.properties.PerT4_21)
    };
}
function apagarPerT4Conc21(e) {
    PerT4Conc21.resetStyle(e.target)
    e.target.closePopup();

} 

function onEachFeaturePerT4Conc21(feature, layer) {
    layer.bindPopup('Concelho: ' + '<b>' + feature.properties.Concelho + '</b>' + '<br>' + 'Proporção de fogos T4 ou mais licenciados: ' + '<b>' + feature.properties.PerT4_21  + '</b>' + '%').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarPerT4Conc21,
    });
}
var PerT4Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloPerT4Conc21,
    onEachFeature: onEachFeaturePerT4Conc21
});
let slidePerT4Conc21 = function(){
    var sliderPerT4Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 195){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderPerT4Conc21, {
        start: [minPerT4Conc21, maxPerT4Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT4Conc21,
    ...
    inputNumberMin.setAttribute("value",minPerT4Conc21);
    inputNumberMax.setAttribute("value",maxPerT4Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT4Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT4Conc21.noUiSlider.set([null, this.value]);
    });

    sliderPerT4Conc21.noUiSlider.on('update',function(e){
        PerT4Conc21.eachLayer(function(layer){
            if(layer.feature.properties.PerT4_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.PerT4_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderPerT4Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 195;
    sliderAtivo = sliderPerT4Conc21.noUiSlider;
    $(slidersGeral).append(sliderPerT4Conc21);
} 

// /////////////////////////////// Fim de T4 CONCELHO em 2021 -------------- \\\\\\
...
var legendaVarTotalConc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]20 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-20 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-43.3 a -20]' + '<br>'
...
var legendaVarT1Conc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-100 a -50]' + '<br>'
...
var legendaVarT2Conc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-40 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-100 a -40]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT3Conc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 60' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]30 a 60]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-34.29 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT4Conc15_14 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-88.89 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-50 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT3Conc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-64.29 a -10]' + '<br>'
...
var legendaVarT4Conc16_15 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-60 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]30 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-47.5 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT1Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-80 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT2Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-50 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-65.22 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT3Conc17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-30 a -25]' + '<br>'
...
var legendaVarTotalConc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]50 a 100]s' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-39.13 a 0]' + '<br>'
...
var legendaVarT3Conc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-23.08 a 0]' + '<br>'
...
var legendaVarT4Conc18_17 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]25 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-57.14 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotalConc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-34.44 a 0]' + '<br>'
...
var legendaVarT2Conc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-49.18 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT3Conc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-45.13 a -25]' + '<br>'
...
var legendaVarT4Conc19_18 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-30 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-63.16 a -30]' + '<br>'
...
var legendaVarTotalConc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-47.37 a -25]' + '<br>'
...
var legendaVarT1Conc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 85' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]20 a 85]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-70 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarT2Conc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-78.57 a -50]' + '<br>'
...
var legendaVarT3Conc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-39.52 a -25]' + '<br>'
...
var legendaVarT4Conc20_19 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-72.73 a -25]' + '<br>'
...
/////////////////////////////------- Variação Total, em 2021, POR CONCELHOS -------------------////

var minVarTotalConc21 = 0;
var maxVarTotalConc21 = 0;

function CorVarTotalConc21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#ff5e6e' :
        d >= 15  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalConc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]> 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-43.88 a -25]' + '<br>'
...
function EstiloVarTotalConc21(feature) {
    if(feature.properties.VarTot_21 <= minVarTotalConc21 || minVarTotalConc21 === 0){
        minVarTotalConc21 = feature.properties.VarTot_21
    }
    if(feature.properties.VarTot_21 > maxVarTotalConc21){
        maxVarTotalConc21 = feature.properties.VarTot_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalConc21_20(feature.properties.VarTot_21)};
    }


function apagarVarTotalConc21(e) {
    VarTotalConc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarTotalConc21(feature, layer) {
    if (feature.properties.VarTot_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarTot_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarTotalConc21,
    });
}
var VarTotalConc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarTotalConc21,
    onEachFeature: onEachFeatureVarTotalConc21
});

let slideVarTotalConc21 = function(){
    var sliderVarTotalConc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 196){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarTotalConc21, {
        start: [minVarTotalConc21, maxVarTotalConc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarTotalConc21,
            'max': maxVarTotalConc21
        },
        });
    inputNumberMin.setAttribute("value",minVarTotalConc21);
    inputNumberMax.setAttribute("value",maxVarTotalConc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarTotalConc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarTotalConc21.noUiSlider.set([null, this.value]);
    });

    sliderVarTotalConc21.noUiSlider.on('update',function(e){
        VarTotalConc21.eachLayer(function(layer){
            if (layer.feature.properties.VarTot_21 == null){
                return false
            }
            if(layer.feature.properties.VarTot_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarTot_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarTotalConc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 196;
    sliderAtivo = sliderVarTotalConc21.noUiSlider;
    $(slidersGeral).append(sliderVarTotalConc21);
} 

///////////////////////////// Fim VARIAÇÃO TOTAL, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação T1, em 2021, POR CONCELHOS -------------------////

var minVarT1Conc21 = 0;
var maxVarT1Conc21 = 0;

function CorVarT1Conc21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT1Conc21_20= function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T0 ou T1 licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' ]-65 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#0b2c40"></i>' + ' [-100 a -65]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
function EstiloVarT1Conc21(feature) {
    if(feature.properties.VarT1_21 <= minVarT1Conc21){
        minVarT1Conc21 = feature.properties.VarT1_21
    }
    if(feature.properties.VarT1_21 > maxVarT1Conc21){
        maxVarT1Conc21 = feature.properties.VarT1_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT1Conc21_20(feature.properties.VarT1_21)};
    }


function apagarVarT1Conc21(e) {
    VarT1Conc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT1Conc21(feature, layer) {
    if (feature.properties.VarT1_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT1_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT1Conc21,
    });
}
var VarT1Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarT1Conc21,
    onEachFeature: onEachFeatureVarT1Conc21
});

let slideVarT1Conc21 = function(){
    var sliderVarT1Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 197){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT1Conc21, {
        start: [minVarT1Conc21, maxVarT1Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT1Conc21,
    ...
    inputNumberMin.setAttribute("value",minVarT1Conc21);
    inputNumberMax.setAttribute("value",maxVarT1Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT1Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT1Conc21.noUiSlider.set([null, this.value]);
    });

    sliderVarT1Conc21.noUiSlider.on('update',function(e){
        VarT1Conc21.eachLayer(function(layer){
            if (layer.feature.properties.VarT1_21 == null){
                return false
            }
            if(layer.feature.properties.VarT1_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT1_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarT1Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 197;
    sliderAtivo = sliderVarT1Conc21.noUiSlider;
    $(slidersGeral).append(sliderVarT1Conc21);
} 

///////////////////////////// Fim VARIAÇÃO T1, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação T2, em 2021, POR CONCELHOS -------------------////

var minVarT2Conc21 = 0;
var maxVarT2Conc21 = 0;

function CorVarT2Conc21_20(d) {
    return d == null ? '#808080' :
        d >= 50  ? '#8c0303' :
        d >= 0  ? '#f5b3be' :
        d >= -15  ? '#ced4ea' :
...
var legendaVarT2Conc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T2 licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-50 a -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-96.15 a -50]' + '<br>'
...
function EstiloVarT2Conc21(feature) {
    if(feature.properties.VarT2_21 <= minVarT2Conc21 || minVarT2Conc21 === 0){
        minVarT2Conc21 = feature.properties.VarT2_21
    }
    if(feature.properties.VarT2_21 > maxVarT2Conc21){
        maxVarT2Conc21 = feature.properties.VarT2_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT2Conc21_20(feature.properties.VarT2_21)};
    }


function apagarVarT2Conc21(e) {
    VarT2Conc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT2Conc21(feature, layer) {
    if (feature.properties.VarT2_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT2_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT2Conc21,
    });
}
var VarT2Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarT2Conc21,
    onEachFeature: onEachFeatureVarT2Conc21
});

let slideVarT2Conc21 = function(){
    var sliderVarT2Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 198){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT2Conc21, {
        start: [minVarT2Conc21, maxVarT2Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT2Conc21,
    ...
    inputNumberMin.setAttribute("value",minVarT2Conc21);
    inputNumberMax.setAttribute("value",maxVarT2Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT2Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT2Conc21.noUiSlider.set([null, this.value]);
    });

    sliderVarT2Conc21.noUiSlider.on('update',function(e){
        VarT2Conc21.eachLayer(function(layer){
            if (layer.feature.properties.VarT2_21 == null){
                return false
            }
            if(layer.feature.properties.VarT2_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT2_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarT2Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 198;
    sliderAtivo = sliderVarT2Conc21.noUiSlider;
    $(slidersGeral).append(sliderVarT2Conc21);
} 

///////////////////////////// Fim VARIAÇÃO T2, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação T3, em 2021, POR CONCELHOS -------------------////

var minVarT3Conc21 = 0;
var maxVarT3Conc21 = 0;

function CorVarT3Conc21_20(d) {
    return d == null ? '#808080' :
        d >= 75  ? '#8c0303' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT3Conc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T3 licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-32 a -25]' + '<br>'
...
function EstiloVarT3Conc21(feature) {
    if(feature.properties.VarT3_21 <= minVarT3Conc21){
        minVarT3Conc21 = feature.properties.VarT3_21
    }
    if(feature.properties.VarT3_21 > maxVarT3Conc21){
        maxVarT3Conc21 = feature.properties.VarT3_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT3Conc21_20(feature.properties.VarT3_21)};
    }


function apagarVarT3Conc21(e) {
    VarT3Conc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT3Conc21(feature, layer) {
    if (feature.properties.VarT3_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT3_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT3Conc21,
    });
}
var VarT3Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarT3Conc21,
    onEachFeature: onEachFeatureVarT3Conc21
});

let slideVarT3Conc21 = function(){
    var sliderVarT3Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 199){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT3Conc21, {
        start: [minVarT3Conc21, maxVarT3Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT3Conc21,
    ...
    inputNumberMin.setAttribute("value",minVarT3Conc21);
    inputNumberMax.setAttribute("value",maxVarT3Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT3Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT3Conc21.noUiSlider.set([null, this.value]);
    });

    sliderVarT3Conc21.noUiSlider.on('update',function(e){
        VarT3Conc21.eachLayer(function(layer){
            if (layer.feature.properties.VarT3_21 == null){
                return false
            }
            if(layer.feature.properties.VarT3_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT3_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarT3Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 199;
    sliderAtivo = sliderVarT3Conc21.noUiSlider;
    $(slidersGeral).append(sliderVarT3Conc21);
} 

///////////////////////////// Fim VARIAÇÃO T3, em 2021 , POR CONCELHOS -------------- \\\\\

/////////////////////////////------- Variação T4, em 2021, POR CONCELHOS -------------------////

var minVarT4Conc21 = 0;
var maxVarT4Conc21 = 0;

function CorVarT4Conc21_20(d) {
    return d == null ? '#808080' :
        d >= 75  ? '#de1f35' :
        d >= 25  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT4Conc21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T4 ou mais licenciados, entre 2021 e 2020, por concelho.' + '</strong>')

    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]25 a 75]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-25 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-56.25 a -25]' + '<br>'
...
function EstiloVarT4Conc21(feature) {
    if(feature.properties.VarT4_21 <= minVarT4Conc21 || minVarT4Conc21 === 0){
        minVarT4Conc21 = feature.properties.VarT4_21
    }
    if(feature.properties.VarT4_21 > maxVarT4Conc21){
        maxVarT4Conc21 = feature.properties.VarT4_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT4Conc21_20(feature.properties.VarT4_21)};
    }


function apagarVarT4Conc21(e) {
    VarT4Conc21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT4Conc21(feature, layer) {
    if (feature.properties.VarT4_21 == null){
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelhos + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT4_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT4Conc21,
    });
}
var VarT4Conc21= L.geoJSON(dadosRelativosConcelhos, {
    style:EstiloVarT4Conc21,
    onEachFeature: onEachFeatureVarT4Conc21
});

let slideVarT4Conc21 = function(){
    var sliderVarT4Conc21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 200){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT4Conc21, {
        start: [minVarT4Conc21, maxVarT4Conc21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT4Conc21,
    ...
    inputNumberMin.setAttribute("value",minVarT4Conc21);
    inputNumberMax.setAttribute("value",maxVarT4Conc21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT4Conc21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT4Conc21.noUiSlider.set([null, this.value]);
    });

    sliderVarT4Conc21.noUiSlider.on('update',function(e){
        VarT4Conc21.eachLayer(function(layer){
            if (layer.feature.properties.VarT4_21 == null){
                return false
            }
            if(layer.feature.properties.VarT4_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT4_21.toFixed(2) <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
        ...
        sliderVarT4Conc21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 200;
    sliderAtivo = sliderVarT4Conc21.noUiSlider;
    $(slidersGeral).append(sliderVarT4Conc21);
} 

///////////////////////////// Fim VARIAÇÃO T4, em 2021 , POR CONCELHOS -------------- \\\\\
...
////////////////////////////----------- TOTAL FOGOS LICENCIAADOS 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minTotalFogosFreg21 = 99999;
var maxTotalFogosFreg21 = 0;
function estiloTotalFogosFreg21(feature, latlng) {
    if(feature.properties.Fog_LTot21< minTotalFogosFreg21 || feature.properties.Fog_LTot21 ===0){
        minTotalFogosFreg21 = feature.properties.Fog_LTot21
    }
    if(feature.properties.Fog_LTot21> maxTotalFogosFreg21){
        maxTotalFogosFreg21 = feature.properties.Fog_LTot21
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_LTot21,2)
    });
}
function apagarTotalFogosFreg21(e){
    var layer = e.target;
    TotalFogosFreg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureTotalFogosFreg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de fogos licenciados: '  + '<b>'+ feature.properties.Fog_LTot21+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarTotalFogosFreg21,
    })
};

var TotalFogosFreg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloTotalFogosFreg21,
    onEachFeature: onEachFeatureTotalFogosFreg21,
});

var slideTotalFogosFreg21 = function(){
    var sliderTotalFogosFreg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 201){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderTotalFogosFreg21, {
        start: [minTotalFogosFreg21, maxTotalFogosFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minTotalFogosFreg21,
            'max': maxTotalFogosFreg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minTotalFogosFreg21);
    inputNumberMax.setAttribute("value",maxTotalFogosFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderTotalFogosFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderTotalFogosFreg21.noUiSlider.set([null, this.value]);
    });

    sliderTotalFogosFreg21.noUiSlider.on('update',function(e){
        TotalFogosFreg21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_LTot21>=parseFloat(e[0])&& layer.feature.properties.Fog_LTot21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderTotalFogosFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 201;
    sliderAtivo = sliderTotalFogosFreg21.noUiSlider;
    $(slidersGeral).append(sliderTotalFogosFreg21);
}
///////////////////////////---------- FIM TOTAL FOGOS LICENCIADOS EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- FOGOS LICENCIADOS T0 E T1 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minFogosT1Freg21 = 99999;
var maxFogosT1Freg21 = 0;
function estiloFogosT1Freg21(feature, latlng) {
    if(feature.properties.Fog_T121< minFogosT1Freg21 || feature.properties.Fog_T121 ===0){
        minFogosT1Freg21 = feature.properties.Fog_T121
    }
    if(feature.properties.Fog_T121> maxFogosT1Freg21){
        maxFogosT1Freg21 = feature.properties.Fog_T121
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T121,2)
    });
}
function apagarFogosT1Freg21(e){
    var layer = e.target;
    FogosT1Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT1Freg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de fogos T0 ou T1 licenciados: '  + '<b>'+ feature.properties.Fog_T121+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT1Freg21,
    })
};

var FogosT1Freg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloFogosT1Freg21,
    onEachFeature: onEachFeatureFogosT1Freg21,
});

var slideFogosT1Freg21 = function(){
    var sliderFogosT1Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 202){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT1Freg21, {
        start: [minFogosT1Freg21, maxFogosT1Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT1Freg21,
            'max': maxFogosT1Freg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT1Freg21);
    inputNumberMax.setAttribute("value",maxFogosT1Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT1Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT1Freg21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT1Freg21.noUiSlider.on('update',function(e){
        FogosT1Freg21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T121>=parseFloat(e[0])&& layer.feature.properties.Fog_T121 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderFogosT1Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 202;
    sliderAtivo = sliderFogosT1Freg21.noUiSlider;
    $(slidersGeral).append(sliderFogosT1Freg21);
}
///////////////////////////---------- FIM FOGOS T0 OU T1 LICENCIADOS EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- FOGOS LICENCIADOS T2 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minFogosT2Freg21 = 99999;
var maxFogosT2Freg21 = 0;
function estiloFogosT2Freg21(feature, latlng) {
    if(feature.properties.Fog_T221< minFogosT2Freg21 || feature.properties.Fog_T221 ===0){
        minFogosT2Freg21 = feature.properties.Fog_T221
    }
    if(feature.properties.Fog_T221> maxFogosT2Freg21){
        maxFogosT2Freg21 = feature.properties.Fog_T221
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T221,2)
    });
}
function apagarFogosT2Freg21(e){
    var layer = e.target;
    FogosT2Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT2Freg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de fogos T2 licenciados: '  + '<b>'+ feature.properties.Fog_T221+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT2Freg21,
    })
};

var FogosT2Freg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloFogosT2Freg21,
    onEachFeature: onEachFeatureFogosT2Freg21,
});

var slideFogosT2Freg21 = function(){
    var sliderFogosT2Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 203){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT2Freg21, {
        start: [minFogosT2Freg21, maxFogosT2Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT2Freg21,
            'max': maxFogosT2Freg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT2Freg21);
    inputNumberMax.setAttribute("value",maxFogosT2Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT2Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT2Freg21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT2Freg21.noUiSlider.on('update',function(e){
        FogosT2Freg21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T221>=parseFloat(e[0])&& layer.feature.properties.Fog_T221 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderFogosT2Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 203;
    sliderAtivo = sliderFogosT2Freg21.noUiSlider;
    $(slidersGeral).append(sliderFogosT2Freg21);
}
///////////////////////////---------- FIM FOGOS T2 LICENCIADOS EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- FOGOS LICENCIADOS T3 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minFogosT3Freg21 = 99999;
var maxFogosT3Freg21 = 0;
function estiloFogosT3Freg21(feature, latlng) {
    if(feature.properties.Fog_T321< minFogosT3Freg21 || feature.properties.Fog_T321 ===0){
        minFogosT3Freg21 = feature.properties.Fog_T321
    }
    if(feature.properties.Fog_T321> maxFogosT3Freg21){
        maxFogosT3Freg21 = feature.properties.Fog_T321
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T321,2)
    });
}
function apagarFogosT3Freg21(e){
    var layer = e.target;
    FogosT3Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT3Freg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de fogos T3 licenciados: '  + '<b>'+ feature.properties.Fog_T321+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT3Freg21,
    })
};

var FogosT3Freg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloFogosT3Freg21,
    onEachFeature: onEachFeatureFogosT3Freg21,
});

var slideFogosT3Freg21 = function(){
    var sliderFogosT3Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 204){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT3Freg21, {
        start: [minFogosT3Freg21, maxFogosT3Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT3Freg21,
            'max': maxFogosT3Freg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT3Freg21);
    inputNumberMax.setAttribute("value",maxFogosT3Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT3Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT3Freg21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT3Freg21.noUiSlider.on('update',function(e){
        FogosT3Freg21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T321>=parseFloat(e[0])&& layer.feature.properties.Fog_T321 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderFogosT3Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 204;
    sliderAtivo = sliderFogosT3Freg21.noUiSlider;
    $(slidersGeral).append(sliderFogosT3Freg21);
}
///////////////////////////---------- FIM FOGOS T3 LICENCIADOS EM 2021,Por Freguesia -----------\\\\\\\\\

////////////////////////////----------- FOGOS LICENCIADOS T4 2021,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minFogosT4Freg21 = 99999;
var maxFogosT4Freg21 = 0;
function estiloFogosT4Freg21(feature, latlng) {
    if(feature.properties.Fog_T421< minFogosT4Freg21 || feature.properties.Fog_T421 ===0){
        minFogosT4Freg21 = feature.properties.Fog_T421
    }
    if(feature.properties.Fog_T421> maxFogosT4Freg21){
        maxFogosT4Freg21 = feature.properties.Fog_T421
    }
    return L.circleMarker(latlng, {
        color: 'black',
        weight: 1,
        fillColor: 'red',
        fillOpacity: 0.7,
        radius: getRadius(feature.properties.Fog_T421,2)
    });
}
function apagarFogosT4Freg21(e){
    var layer = e.target;
    FogosT4Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeatureFogosT4Freg21(feature, layer) {
    layer.bindPopup( 'Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: '+ '<b>' + feature.properties.Concelho + '</b>' + ' <br> ' + 'Total de fogos T4 licenciados: '  + '<b>'+ feature.properties.Fog_T421+ '</b>' ).openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarFogosT4Freg21,
    })
};

var FogosT4Freg21= L.geoJSON(dadosAbsolutosFreguesias,{
    pointToLayer:estiloFogosT4Freg21,
    onEachFeature: onEachFeatureFogosT4Freg21,
});

var slideFogosT4Freg21 = function(){
    var sliderFogosT4Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 205){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderFogosT4Freg21, {
        start: [minFogosT4Freg21, maxFogosT4Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minFogosT4Freg21,
            'max': maxFogosT4Freg21
        },
        format:{
            to: (v) => v | 0,
            from: (v) => v | 0
    ...
    inputNumberMin.setAttribute("value",minFogosT4Freg21);
    inputNumberMax.setAttribute("value",maxFogosT4Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderFogosT4Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderFogosT4Freg21.noUiSlider.set([null, this.value]);
    });

    sliderFogosT4Freg21.noUiSlider.on('update',function(e){
        FogosT4Freg21.eachLayer(function(layer){
            if(layer.feature.properties.Fog_T421>=parseFloat(e[0])&& layer.feature.properties.Fog_T421 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
    ...
    sliderFogosT4Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 205;
    sliderAtivo = sliderFogosT4Freg21.noUiSlider;
    $(slidersGeral).append(sliderFogosT4Freg21);
}
///////////////////////////---------- FIM FOGOS T4 LICENCIADOS EM 2021,Por Freguesia -----------\\\\\\\\\
...
var legendaPerTFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 90' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 75 a 90' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 50 a 75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 25 a 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0 a 25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
////////////////////////////////////----------- PERCENTAGEM T1, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerT1Freg21 = 99999;
var maxPerT1Freg21 = 0;
function estiloPerT1Freg21(feature) {
    if(feature.properties.PerT1_21< minPerT1Freg21  && feature.properties.PerT1_21 != null){
        minPerT1Freg21 = feature.properties.PerT1_21
    }
    if(feature.properties.PerT1_21> maxPerT1Freg21 && feature.properties.PerT1_21 != null){
        maxPerT1Freg21 = feature.properties.PerT1_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerTFreg(feature.properties.PerT1_21)
    };
}
function apagarPerT1Freg21(e){
    var layer = e.target;
    PerT1Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerT1Freg21(feature, layer) {
    if (feature.properties.PerT1_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T0 ou T1 licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T0 ou T1 licenciados: ' + '<b>' +feature.properties.PerT1_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerT1Freg21,
    })
};

var PerT1Freg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerT1Freg21,
    onEachFeature: onEachFeaturePerT1Freg21,
});

var slidePerT1Freg21 = function(){
    var sliderPerT1Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 206){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderPerT1Freg21, {
        start: [minPerT1Freg21, maxPerT1Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT1Freg21,
    ...
    inputNumberMin.setAttribute("value",minPerT1Freg21);
    inputNumberMax.setAttribute("value",maxPerT1Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT1Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT1Freg21.noUiSlider.set([null, this.value]);
    });

    sliderPerT1Freg21.noUiSlider.on('update',function(e){
        PerT1Freg21.eachLayer(function(layer){
            if (layer.feature.properties.PerT1_21 == null){
                return false
            }
            if(layer.feature.properties.PerT1_21>=parseFloat(e[0])&& layer.feature.properties.PerT1_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerT1Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 206;
    sliderAtivo = sliderPerT1Freg21.noUiSlider;
    $(slidersGeral).append(sliderPerT1Freg21);
}
///////////////////////////-------------------- FIM FREGUESIA T1, EM 2021,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- PERCENTAGEM T2, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerT2Freg21 = 99999;
var maxPerT2Freg21 = 0;
function estiloPerT2Freg21(feature) {
    if(feature.properties.PerT2_21< minPerT2Freg21  && feature.properties.PerT2_21 != null){
        minPerT2Freg21 = feature.properties.PerT2_21
    }
    if(feature.properties.PerT2_21> maxPerT2Freg21 && feature.properties.PerT2_21 != null){
        maxPerT2Freg21 = feature.properties.PerT2_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerTFreg(feature.properties.PerT2_21)
    };
}
function apagarPerT2Freg21(e){
    var layer = e.target;
    PerT2Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerT2Freg21(feature, layer) {
    if (feature.properties.PerT2_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T2 licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T2 licenciados: ' + '<b>' +feature.properties.PerT2_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerT2Freg21,
    })
};

var PerT2Freg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerT2Freg21,
    onEachFeature: onEachFeaturePerT2Freg21,
});

var slidePerT2Freg21 = function(){
    var sliderPerT2Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 207){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderPerT2Freg21, {
        start: [minPerT2Freg21, maxPerT2Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT2Freg21,
    ...
    inputNumberMin.setAttribute("value",minPerT2Freg21);
    inputNumberMax.setAttribute("value",maxPerT2Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT2Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT2Freg21.noUiSlider.set([null, this.value]);
    });

    sliderPerT2Freg21.noUiSlider.on('update',function(e){
        PerT2Freg21.eachLayer(function(layer){
            if (layer.feature.properties.PerT2_21 == null){
                return false
            }
            if(layer.feature.properties.PerT2_21>=parseFloat(e[0])&& layer.feature.properties.PerT2_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerT2Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 207;
    sliderAtivo = sliderPerT2Freg21.noUiSlider;
    $(slidersGeral).append(sliderPerT2Freg21);
}
///////////////////////////-------------------- FIM FREGUESIA T2, EM 2021,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\

////////////////////////////////////----------- PERCENTAGEM T3, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerT3Freg21 = 99999;
var maxPerT3Freg21 = 0;
function estiloPerT3Freg21(feature) {
    if(feature.properties.PerT3_21< minPerT3Freg21  && feature.properties.PerT3_21 != null){
        minPerT3Freg21 = feature.properties.PerT3_21
    }
    if(feature.properties.PerT3_21> maxPerT3Freg21 && feature.properties.PerT3_21 != null){
        maxPerT3Freg21 = feature.properties.PerT3_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerTFreg(feature.properties.PerT3_21)
    };
}
function apagarPerT3Freg21(e){
    var layer = e.target;
    PerT3Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerT3Freg21(feature, layer) {
    if (feature.properties.PerT3_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T3 licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T3 licenciados: ' + '<b>' +feature.properties.PerT3_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerT3Freg21,
    })
};

var PerT3Freg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerT3Freg21,
    onEachFeature: onEachFeaturePerT3Freg21,
});

var slidePerT3Freg21 = function(){
    var sliderPerT3Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 208){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderPerT3Freg21, {
        start: [minPerT3Freg21, maxPerT3Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT3Freg21,
    ...
    inputNumberMin.setAttribute("value",minPerT3Freg21);
    inputNumberMax.setAttribute("value",maxPerT3Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT3Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT3Freg21.noUiSlider.set([null, this.value]);
    });

    sliderPerT3Freg21.noUiSlider.on('update',function(e){
        PerT3Freg21.eachLayer(function(layer){
            if (layer.feature.properties.PerT3_21 == null){
                return false
            }
            if(layer.feature.properties.PerT3_21>=parseFloat(e[0])&& layer.feature.properties.PerT3_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerT3Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 208;
    sliderAtivo = sliderPerT3Freg21.noUiSlider;
    $(slidersGeral).append(sliderPerT3Freg21);
}
///////////////////////////-------------------- FIM FREGUESIA T3, EM 2021,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\


////////////////////////////////////----------- PERCENTAGEM T4, EM 2021 ,Por Freguesia ------------------------------\\\\\\\\\\\\\

var minPerT4Freg21 = 99999;
var maxPerT4Freg21 = 0;
function estiloPerT4Freg21(feature) {
    if(feature.properties.PerT4_21< minPerT4Freg21  && feature.properties.PerT4_21 != null){
        minPerT4Freg21 = feature.properties.PerT4_21
    }
    if(feature.properties.PerT4_21> maxPerT4Freg21 && feature.properties.PerT4_21 != null){
        maxPerT4Freg21 = feature.properties.PerT4_21
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorPerTFreg(feature.properties.PerT4_21)
    };
}
function apagarPerT4Freg21(e){
    var layer = e.target;
    PerT4Freg21.resetStyle(layer)
    layer.closePopup();
}


function onEachFeaturePerT4Freg21(feature, layer) {
    if (feature.properties.PerT4_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T4 ou mais licenciados: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Proporção de fogos T4 ou mais licenciados: ' + '<b>' +feature.properties.PerT4_21 + '%' +'</b>' ).openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
        mouseout:apagarPerT4Freg21,
    })
};

var PerT4Freg21= L.geoJSON(dadosRelativosFreguesias,{
    style:estiloPerT4Freg21,
    onEachFeature: onEachFeaturePerT4Freg21,
});

var slidePerT4Freg21 = function(){
    var sliderPerT4Freg21 = document.querySelector('.sliderAtivo');

    
    if (ifSlide2isActive != 209){
        sliderAtivo.destroy();
    } 

    noUiSlider.create(sliderPerT4Freg21, {
        start: [minPerT4Freg21, maxPerT4Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minPerT4Freg21,
    ...
    inputNumberMin.setAttribute("value",minPerT4Freg21);
    inputNumberMax.setAttribute("value",maxPerT4Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderPerT4Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderPerT4Freg21.noUiSlider.set([null, this.value]);
    });

    sliderPerT4Freg21.noUiSlider.on('update',function(e){
        PerT4Freg21.eachLayer(function(layer){
            if (layer.feature.properties.PerT4_21 == null){
                return false
            }
            if(layer.feature.properties.PerT4_21>=parseFloat(e[0])&& layer.feature.properties.PerT4_21 <= parseFloat(e[1])){
                layer.addTo(map);
            }
            else{
                map.removeLayer(layer);
    ...
    sliderPerT4Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 209;
    sliderAtivo = sliderPerT4Freg21.noUiSlider;
    $(slidersGeral).append(sliderPerT4Freg21);
}
///////////////////////////-------------------- FIM FREGUESIA T4, EM 2020,Por Freguesia -----------\\\\\\\\\\\\\\\\\\\\\\\
...
var legendaVarT2Freg17_16 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#8c0303"></i>' + ' ]> 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]50 a 100]s' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-100 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Não aplicável' + '<br>'
...
/////////////////////////////------- Variação Total, em 2021, POR FREGUESIAS -------------------////

var minVarTotalFreg21 = 9999;
var maxVarTotalFreg21 = 0;

function CorVarTotalFreg21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarTotalFreg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarTotalFreg21(feature) {
    if(feature.properties.VarTot_21 <= minVarTotalFreg21){
        minVarTotalFreg21 = feature.properties.VarTot_21
    }
    if(feature.properties.VarTot_21 > maxVarTotalFreg21){
        maxVarTotalFreg21 = feature.properties.VarTot_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarTotalFreg21_20(feature.properties.VarTot_21)};
    }


function apagarVarTotalFreg21(e) {
    VarTotalFreg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarTotalFreg21(feature, layer) {
    if (feature.properties.VarTot_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarTot_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarTotalFreg21,
    });
}
var VarTotalFreg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarTotalFreg21,
    onEachFeature: onEachFeatureVarTotalFreg21
});

let slideVarTotalFreg21 = function(){
    var sliderVarTotalFreg21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 210){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarTotalFreg21, {
        start: [minVarTotalFreg21, maxVarTotalFreg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarTotalFreg21,
            'max': maxVarTotalFreg21
        },
        });
    inputNumberMin.setAttribute("value",minVarTotalFreg21);
    inputNumberMax.setAttribute("value",maxVarTotalFreg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarTotalFreg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarTotalFreg21.noUiSlider.set([null, this.value]);
    });

    sliderVarTotalFreg21.noUiSlider.on('update',function(e){
        VarTotalFreg21.eachLayer(function(layer){
            if (layer.feature.properties.VarTot_21 == null){
                return false
            }
            if(layer.feature.properties.VarTot_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarTot_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarTotalFreg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 210;
    sliderAtivo = sliderVarTotalFreg21.noUiSlider;
    $(slidersGeral).append(sliderVarTotalFreg21);
} 

///////////////////////////// Fim VARIAÇÃO TOTAL, em 2021 , POR FREGUESIAS -------------- \\\\\

/////////////////////////////------- Variação T1, em 2021, POR FREGUESIAS -------------------////

var minVarT1Freg21 = 9999;
var maxVarT1Freg21 = 0;

function CorVarT1Freg21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT1Freg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T0 ou T1 licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarT1Freg21(feature) {
    if(feature.properties.VarT1_21 <= minVarT1Freg21){
        minVarT1Freg21 = feature.properties.VarT1_21
    }
    if(feature.properties.VarT1_21 > maxVarT1Freg21){
        maxVarT1Freg21 = feature.properties.VarT1_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT1Freg21_20(feature.properties.VarT1_21)};
    }


function apagarVarT1Freg21(e) {
    VarT1Freg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT1Freg21(feature, layer) {
    if (feature.properties.VarT1_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT1_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT1Freg21,
    });
}
var VarT1Freg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarT1Freg21,
    onEachFeature: onEachFeatureVarT1Freg21
});

let slideVarT1Freg21 = function(){
    var sliderVarT1Freg21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 211){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT1Freg21, {
        start: [minVarT1Freg21, maxVarT1Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT1Freg21,
    ...
    inputNumberMin.setAttribute("value",minVarT1Freg21);
    inputNumberMax.setAttribute("value",maxVarT1Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT1Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT1Freg21.noUiSlider.set([null, this.value]);
    });

    sliderVarT1Freg21.noUiSlider.on('update',function(e){
        VarT1Freg21.eachLayer(function(layer){
            if (layer.feature.properties.VarT1_21 == null){
                return false
            }
            if(layer.feature.properties.VarT1_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT1_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarT1Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 211;
    sliderAtivo = sliderVarT1Freg21.noUiSlider;
    $(slidersGeral).append(sliderVarT1Freg21);
} 

///////////////////////////// Fim VARIAÇÃO T1, em 2021 , POR FREGUESIAS -------------- \\\\\

/////////////////////////////------- Variação T2, em 2021, POR FREGUESIAS -------------------////

var minVarT2Freg21 = 9999;
var maxVarT2Freg21 = 0;

function CorVarT2Freg21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT2Freg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T2 licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarT2Freg21(feature) {
    if(feature.properties.VarT2_21 <= minVarT2Freg21){
        minVarT2Freg21 = feature.properties.VarT2_21
    }
    if(feature.properties.VarT2_21 > maxVarT2Freg21){
        maxVarT2Freg21 = feature.properties.VarT2_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT2Freg21_20(feature.properties.VarT2_21)};
    }


function apagarVarT2Freg21(e) {
    VarT2Freg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT2Freg21(feature, layer) {
    if (feature.properties.VarT2_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT2_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT2Freg21,
    });
}
var VarT2Freg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarT2Freg21,
    onEachFeature: onEachFeatureVarT2Freg21
});

let slideVarT2Freg21 = function(){
    var sliderVarT2Freg21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 212){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT2Freg21, {
        start: [minVarT2Freg21, maxVarT2Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT2Freg21,
    ...
    inputNumberMin.setAttribute("value",minVarT2Freg21);
    inputNumberMax.setAttribute("value",maxVarT2Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT2Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT2Freg21.noUiSlider.set([null, this.value]);
    });

    sliderVarT2Freg21.noUiSlider.on('update',function(e){
        VarT2Freg21.eachLayer(function(layer){
            if (layer.feature.properties.VarT2_21 == null){
                return false
            }
            if(layer.feature.properties.VarT2_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT2_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarT2Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 212;
    sliderAtivo = sliderVarT2Freg21.noUiSlider;
    $(slidersGeral).append(sliderVarT2Freg21);
} 

///////////////////////////// Fim VARIAÇÃO T2, em 2021 , POR FREGUESIAS -------------- \\\\\

/////////////////////////////------- Variação T3, em 2021, POR FREGUESIAS -------------------////

var minVarT3Freg21 = 9999;
var maxVarT3Freg21 = 0;

function CorVarT3Freg21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT3Freg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T3 licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarT3Freg21(feature) {
    if(feature.properties.VarT3_21 <= minVarT3Freg21){
        minVarT3Freg21 = feature.properties.VarT3_21
    }
    if(feature.properties.VarT3_21 > maxVarT3Freg21){
        maxVarT3Freg21 = feature.properties.VarT3_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT3Freg21_20(feature.properties.VarT3_21)};
    }


function apagarVarT3Freg21(e) {
    VarT3Freg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT3Freg21(feature, layer) {
    if (feature.properties.VarT3_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT3_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT3Freg21,
    });
}
var VarT3Freg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarT3Freg21,
    onEachFeature: onEachFeatureVarT3Freg21
});

let slideVarT3Freg21 = function(){
    var sliderVarT3Freg21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 213){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT3Freg21, {
        start: [minVarT3Freg21, maxVarT3Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT3Freg21,
    ...
    inputNumberMin.setAttribute("value",minVarT3Freg21);
    inputNumberMax.setAttribute("value",maxVarT3Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT3Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT3Freg21.noUiSlider.set([null, this.value]);
    });

    sliderVarT3Freg21.noUiSlider.on('update',function(e){
        VarT3Freg21.eachLayer(function(layer){
            if (layer.feature.properties.VarT3_21 == null){
                return false
            }
            if(layer.feature.properties.VarT3_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT3_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarT3Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 213;
    sliderAtivo = sliderVarT3Freg21.noUiSlider;
    $(slidersGeral).append(sliderVarT3Freg21);
} 

///////////////////////////// Fim VARIAÇÃO T3, em 2021 , POR FREGUESIAS -------------- \\\\\


/////////////////////////////------- Variação T4, em 2021, POR FREGUESIAS -------------------////

var minVarT4Freg21 = 9999;
var maxVarT4Freg21 = 0;

function CorVarT4Freg21_20(d) {
    return d == null ? '#808080' :
        d >= 100  ? '#8c0303' :
        d >= 50  ? '#f5b3be' :
        d >= 0  ? '#fbcec6' :
...
var legendaVarT4Freg21_20 = function() {
    legendaA.textContent = '';
    legendaA.style.textAlign = 'left';
    legendaA.style.visibility = "visible";
    let symbolsContainer = document.createElement("div");
    ...
    $(legendaA).append("<div class='subheader'>" + 'Unidade de medida: %' +"</div>") 
    $('#tituloMapa').html(' <strong>' + 'Variação do total de fogos T4 ou mais licenciados, entre 2021 e 2020, por freguesia.' + '</strong>')
...
function EstiloVarT4Freg21(feature) {
    if(feature.properties.VarT4_21 <= minVarT4Freg21){
        minVarT4Freg21 = feature.properties.VarT4_21
    }
    if(feature.properties.VarT4_21 > maxVarT4Freg21){
        maxVarT4Freg21 = feature.properties.VarT4_21 
    }
    return {
        weight: 1,
        opacity: 1,
        ...
        dashArray: '1',
        fillOpacity: 0.8,
        fillColor: CorVarT4Freg21_20(feature.properties.VarT4_21)};
    }


function apagarVarT4Freg21(e) {
    VarT4Freg21.resetStyle(e.target)
    e.target.closePopup();
} 

function onEachFeatureVarT4Freg21(feature, layer) {
    if (feature.properties.VarT4_21 == null){
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + 'Não aplicável' + '</b>').openPopup()
    }
    else{
        layer.bindPopup('Freguesia: ' + '<b>' +feature.properties.Freguesia + '</b>' + '<br>' + 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Variação: ' + '<b>' + feature.properties.VarT4_21.toFixed(2) + '</b>' + '%').openPopup()
    }
    layer.on({
        click: zoomToFeature,
        mouseover: hover,
        mouseout: apagarVarT4Freg21,
    });
}
var VarT4Freg21= L.geoJSON(dadosRelativosFreguesias, {
    style:EstiloVarT4Freg21,
    onEachFeature: onEachFeatureVarT4Freg21
});

let slideVarT4Freg21 = function(){
    var sliderVarT4Freg21 = document.querySelector('.sliderAtivo');


    if (ifSlide2isActive != 214){
        sliderAtivo.destroy();
    }

    noUiSlider.create(sliderVarT4Freg21, {
        start: [minVarT4Freg21, maxVarT4Freg21],
        tooltips:true,
        connect: true,
        range: {
            'min': minVarT4Freg21,
    ...
    inputNumberMin.setAttribute("value",minVarT4Freg21);
    inputNumberMax.setAttribute("value",maxVarT4Freg21);

    inputNumberMin.addEventListener('change', function(){
        sliderVarT4Freg21.noUiSlider.set([this.value, null]);
    });
    inputNumberMax.addEventListener('change', function(){
        sliderVarT4Freg21.noUiSlider.set([null, this.value]);
    });

    sliderVarT4Freg21.noUiSlider.on('update',function(e){
        VarT4Freg21.eachLayer(function(layer){
            if (layer.feature.properties.VarT4_21 == null){
                return false
            }
            if(layer.feature.properties.VarT4_21.toFixed(2)>=parseFloat(e[0])&& layer.feature.properties.VarT4_21.toFixed(2) <= parseFloat(e[1])){
        ...
        sliderVarT4Freg21.noUiSlider.on('update', function( values, handle ) {
        if (handle==0){
            inputNumberMin.value = values[0];
        } else {
            inputNumberMax.value =  values[1];
    ...
    ifSlide2isActive = 214;
    sliderAtivo = sliderVarT4Freg21.noUiSlider;
    $(slidersGeral).append(sliderVarT4Freg21);
} 

///////////////////////////// Fim VARIAÇÃO T4, em 2021 , POR FREGUESIAS -------------- \\\\\
...
let novaLayer = function(layer){
    ...
    if (layer == TotalFogosConc21 && naoDuplicar != 187){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos licenciados, em 2021, por concelho.' + '</strong>')
        legenda(maxTotalFogosConc21, ((maxTotalFogosConc21-minTotalFogosConc21)/2).toFixed(0),minTotalFogosConc21,1.3);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideTotalFogosConc21();
        naoDuplicar = 187;
    }
    if (layer == FogosT1Conc21 && naoDuplicar != 188){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T0 ou T1 licenciados, em 2021, por concelho.' + '</strong>');
        legenda(maxFogosT1Conc21, ((maxFogosT1Conc21-minFogosT1Conc21)/2).toFixed(0),minFogosT1Conc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideFogosT1Conc21();
        naoDuplicar = 188;
    }
    if (layer == FogosT2Conc21 && naoDuplicar != 189){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T2 licenciados, em 2021, por concelho.' + '</strong>');
        legenda(maxFogosT2Conc21, ((maxFogosT2Conc21-minFogosT2Conc21)/2).toFixed(0),minFogosT2Conc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideFogosT2Conc21();
        naoDuplicar = 189;
    }
    if (layer == FogosT3Conc21 && naoDuplicar != 190){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T3 licenciados, em 2021, por concelho.' + '</strong>');
        legenda(maxFogosT3Conc21, ((maxFogosT3Conc21-minFogosT3Conc21)/2).toFixed(0),minFogosT3Conc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideFogosT3Conc21();
        naoDuplicar = 190;
    }
    if (layer == FogosT4Conc21 && naoDuplicar != 191){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T4 ou mais licenciados, em 2021, por concelho.' + '</strong>');
        legenda(maxFogosT4Conc21, ((maxFogosT4Conc21-minFogosT4Conc21)/2).toFixed(0),minFogosT4Conc21,1.8);
        contorno.addTo(map);
        baseAtiva = contorno;
        slideFogosT4Conc21();
        naoDuplicar = 191;
    ...
    if (layer == PerT1Conc21 && naoDuplicar != 192){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T0 ou T1 licenciados, em 2021, por concelho.' + '</strong>')
        legendaPerT1Conc();
        slidePerT1Conc21();
        naoDuplicar = 192;
    }
    if (layer == PerT2Conc21 && naoDuplicar != 193){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T2 licenciados, em 2021, por concelho.' + '</strong>')
        legendaPerT2Conc();
        slidePerT2Conc21();
        naoDuplicar = 193;
    }
    if (layer == PerT3Conc21 && naoDuplicar != 194){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T3 licenciados, em 2021, por concelho.' + '</strong>')
        legendaPerT3Conc();
        slidePerT3Conc21();
        naoDuplicar = 194;
    }
    if (layer == PerT4Conc21 && naoDuplicar != 195){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T4 ou mais licenciados, em 2021, por concelho.' + '</strong>')
        legendaPerT4Conc();
        slidePerT4Conc21();
        naoDuplicar = 195;
    }
    ...
    if (layer == VarTotalConc21 && naoDuplicar != 196){
        legendaVarTotalConc21_20();
        slideVarTotalConc21();
        naoDuplicar = 196;
    }
    if (layer == VarT1Conc21 && naoDuplicar != 197){
        legendaVarT1Conc21_20();
        slideVarT1Conc21();
        naoDuplicar = 197;
    }
    if (layer == VarT2Conc21 && naoDuplicar != 198){
        legendaVarT2Conc21_20();
        slideVarT2Conc21();
        naoDuplicar = 198;
    }
    if (layer == VarT3Conc21 && naoDuplicar != 199){
        legendaVarT3Conc21_20();
        slideVarT3Conc21();
        naoDuplicar = 199;
    }
    if (layer == VarT4Conc21 && naoDuplicar != 200){
        legendaVarT4Conc21_20();
        slideVarT4Conc21();
        naoDuplicar = 200;
    }
    ...
    if (layer == TotalFogosFreg21 && naoDuplicar != 201){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos licenciados, em 2021, por freguesia.' + '</strong>');
        legenda(maxTotalFogosFreg21, ((maxTotalFogosFreg21-minTotalFogosFreg21)/2).toFixed(0),minTotalFogosFreg21,1.3);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideTotalFogosFreg21();
        naoDuplicar = 201;
    }
    if (layer == FogosT1Freg21 && naoDuplicar != 202){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T0 ou T1 licenciados, em 2021, por freguesia.' + '</strong>');
        legenda(maxFogosT1Freg21, ((maxFogosT1Freg21-minFogosT1Freg21)/2).toFixed(0),minFogosT1Freg21,1.3);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideFogosT1Freg21();
        naoDuplicar = 202;
    }
    if (layer == FogosT2Freg21 && naoDuplicar != 203){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T2 licenciados, em 2021, por freguesia.' + '</strong>');
        legenda(maxFogosT2Freg21, ((maxFogosT2Freg21-minFogosT2Freg21)/2).toFixed(0),minFogosT2Freg21,1.3);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideFogosT2Freg21();
        naoDuplicar = 203;
    }
    if (layer == FogosT3Freg21 && naoDuplicar != 204){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T3 licenciados, em 2021, por freguesia.' + '</strong>');
        legenda(maxFogosT3Freg21, ((maxFogosT3Freg21-minFogosT3Freg21)/2).toFixed(0),minFogosT3Freg21,1.3);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideFogosT3Freg21();
        naoDuplicar = 204;
    }
    if (layer == FogosT4Freg21 && naoDuplicar != 205){
        $('#tituloMapa').html(' <strong>' + 'Total de fogos T4 ou mais licenciados, em 2021, por freguesia.' + '</strong>');
        legendaExcecao(maxFogosT4Freg21, ((maxFogosT4Freg21-minFogosT4Freg21)/2).toFixed(0),minFogosT4Freg21,1.3);
        contornoFreg.addTo(map);
        baseAtiva = contornoFreg;
        slideFogosT4Freg21();
        naoDuplicar = 205;
    ...
    if (layer == PerT1Freg21 && naoDuplicar != 206){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T0 ou T1 licenciados, em 2021, por freguesia.' + '</strong>');
        legendaPerTFreg();
        slidePerT1Freg21();
        naoDuplicar = 206;
    }
    if (layer == PerT2Freg21 && naoDuplicar != 207){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T2 licenciados, em 2021, por freguesia.' + '</strong>');
        legendaPerTFreg();
        slidePerT2Freg21();
        naoDuplicar = 207;
    }
    if (layer == PerT3Freg21 && naoDuplicar != 208){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T3 licenciados, em 2021, por freguesia.' + '</strong>');
        legendaPerTFreg();
        slidePerT3Freg21();
        naoDuplicar = 208;
    }
    if (layer == PerT4Freg21 && naoDuplicar != 209){
        $('#tituloMapa').html(' <strong>' + 'Proporção de fogos T4 licenciados, em 2021, por freguesia.' + '</strong>');
        legendaPerTFreg();
        slidePerT4Freg21();
        naoDuplicar = 209;
    }
    ...
    if (layer == VarTotalFreg21 && naoDuplicar != 210){
        legendaVarTotalFreg21_20();
        slideVarTotalFreg21();
        naoDuplicar = 210;
    }
    if (layer == VarT1Freg21 && naoDuplicar != 211){
        legendaVarT1Freg21_20();
        slideVarT1Freg21();
        naoDuplicar = 211;
    }
    if (layer == VarT2Freg21 && naoDuplicar != 212){
        legendaVarT2Freg21_20();
        slideVarT2Freg21();
        naoDuplicar = 212;
    }
    if (layer == VarT3Freg21 && naoDuplicar != 213){
        legendaVarT3Freg21_20();
        slideVarT3Freg21();
        naoDuplicar = 213;
    }
    if (layer == VarT4Freg21 && naoDuplicar != 214){
        legendaVarT4Freg21_20();
        slideVarT4Freg21();
        naoDuplicar = 214;
    }
    layer.addTo(map);
...
function myFunction() {
    ...
    if ($('#concelho').hasClass('active2')){
        if ($('#absoluto').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(TotalFogosConc21)
            }
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(FogosT1Conc21);
                notaRodape('Devido aos valores reduzidos, optou-se por aumentar a proporção dos círculos de forma que seja possível uma melhor perceção, não devendo, assim, comparar com os' + '<b>' + ' dados totais à escala concelhia e aos dados à escala da freguesia.'  + '</b>')
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(FogosT2Conc21);
                notaRodape('Devido aos valores reduzidos, optou-se por aumentar a proporção dos círculos de forma que seja possível uma melhor perceção, não devendo, assim, comparar com os' + '<b>' + ' dados totais à escala concelhia e aos dados à escala da freguesia.'  + '</b>')
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(FogosT3Conc21);
                notaRodape('Devido aos valores reduzidos, optou-se por aumentar a proporção dos círculos de forma que seja possível uma melhor perceção, não devendo, assim, comparar com os' + '<b>' + ' dados totais à escala concelhia e aos dados à escala da freguesia.'  + '</b>')
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(FogosT4Conc21);
                notaRodape('Devido aos valores reduzidos, optou-se por aumentar a proporção dos círculos de forma que seja possível uma melhor perceção, não devendo, assim, comparar com os' + '<b>' + ' dados totais à escala concelhia e aos dados à escala da freguesia.'  + '</b>')
            }   
        }
    if ($('#percentagem').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(PerT1Conc21)
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(PerT2Conc21)
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(PerT3Conc21)
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(PerT4Conc21)
            }
        }
        if ($('#taxaVariacao').hasClass('active4')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(VarTotalConc21)
            }
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(VarT1Conc21)
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(VarT2Conc21)
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(VarT3Conc21)
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(VarT4Conc21)
            }  
        }
    }
    if ($('#freguesias').hasClass('active2')){
        if ($('#absoluto').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(TotalFogosFreg21);
                notaRodape('Devido aos valores reduzidos, optou-se por aumentar a proporção dos círculos de forma que seja possível uma melhor perceção, não devendo, assim, comparar com os' + '<b>' + ' dados totais à escala concelhia e aos dados das várias tipologias de fogo.'  + '</b>')
            }
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(FogosT1Freg21)
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(FogosT2Freg21)
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(FogosT3Freg21)
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(FogosT4Freg21)
            }  
        }
        if ($('#percentagem').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(PerT1Freg21)
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(PerT2Freg21)
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(PerT3Freg21)
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(PerT4Freg21)
            }  
        }
        if ($('#taxaVariacao').hasClass('active5')){
            ...
            if (ano == "2021" && tipologia == "Total"){
                novaLayer(VarTotalFreg21)
            }
            if (ano == "2021" && tipologia == "T1"){
                novaLayer(VarT1Freg21)
            }
            if (ano == "2021" && tipologia == "T2"){
                novaLayer(VarT2Freg21)
            } 
            if (ano == "2021" && tipologia == "T3"){
                novaLayer(VarT3Freg21)
            }
            if (ano == "2021" && tipologia == "T4"){
                novaLayer(VarT4Freg21)
            }         
        }
    }
}
...
let reporAnos = function(){
    if ($('#absoluto').hasClass('active4') || $('#percentagem').hasClass('active4') || $('#absoluto').hasClass('active5') || $('#percentagem').hasClass('active5')){
        ...
        $("#mySelect option[value='2021']").html("2021");
    ...
    if ($('#taxaVariacao').hasClass('active4') || $('#taxaVariacao').hasClass('active5')){
        ...
        $("#mySelect option[value='2021']").html("2021 - 2020");
...
$('#opcaoFonte').click(function(){
    ...
    $('#tabelaVariacao').attr("class","butao");
    $('#tabelaPercentagem').attr("class","butao");
    $('#tabelaDadosAbsolutos').attr("class","butao")
...
$('#opcaoTabela').click(function(){
    ...
    $('#tabelaDadosAbsolutos').attr("class","butao active1");
    DadosAbsolutos();
    $('#opcaoMapa').attr("class","btn");
...
var DadosAbsolutos = function(){
    $('#tituloMapa').html('Número de fogos licenciados, segundo a tipologia, entre 2014 e 2021, Nº.');
...
$('#tabelaPercentagem').click(function(){
    $('#tituloMapa').html('Proporção do número de fogos licenciados, segundo a tipologia, entre 2014 e 2021, %.')
        $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/FogosLicenciadosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
...
$('#tabelaVariacao').click(function(){  
    $('#tituloMapa').html('Variação do número de fogos licenciados, segundo a tipologia, entre 2014 e 2021, %.')
    $(document).ready(function(){
        $.getJSON("https://raw.githubusercontent.com/diogoomb/links/main/FogosLicenciadosProv.json", function(data){
            $('#juntarValores').empty();
            var dados = '';
