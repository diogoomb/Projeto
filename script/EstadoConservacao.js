...
var legendaPerSemNecessidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 70.42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 64.72 - 70.42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 55.14 - 64.72' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 45.56 - 55.14' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 35.98 - 45.56' + '<br>'
...
var legendaPerComNecessidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 53.04' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 48.29 - 53.04' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 40.37 - 48.29' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 32.44 - 40.37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 24.52 - 32.44' + '<br>'
...
var legendaPerMtDegradadoConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 7.1' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 6.03 - 7.1' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 4.25 - 6.03' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 2.46 - 4.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.68 - 2.46' + '<br>'
...
var legendaVarSemNecessidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [6.58 a 15]' + '<br>'
...
var legendaVarComNecessidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-20 a -10]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-29.38 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMtDegradadosConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-40 a -20]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#0b2c40"></i>' + ' [-70.93 a -60]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPerSemNecessidadeFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 83.97' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 70.95 - 83.97' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 49.25 - 70.95' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 27.55 - 49.25' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 5.85 - 27.55' + '<br>'
...
var legendaPerComNecessidadeFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 79.83' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 67.68 - 79.83' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 47.43 - 67.68' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 27.18 - 47.43' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 6.93 - 27.18' + '<br>'
...
var legendaPerMtDegradadoFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 34.98' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 29.21 - 34.98' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 19.58 - 29.21' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 9.96 - 19.58' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.33 - 9.96' + '<br>'
...
var legendaVarSemNecessidadeFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-45.11 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarComNecessidadeFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-81.14 a -50]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
