...
var legendaPerEdi1AlojConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 93.22' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 87.91 - 93.22' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 79.05 - 87.91' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 70.2 - 79.05' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 61.34 - 70.2' + '<br>'
...
var legendaPerEdi2a4AlojConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 18.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 15.9 - 18.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 11.65 - 15.9' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 7.39 - 11.65' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 3.13 - 7.39' + '<br>'
...
var legendaPerEdi5a9AlojConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 11.35' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 9.47 - 11.35' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 6.35 - 9.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 3.22 - 6.35' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.09 - 3.22' + '<br>'
...
var legendaPerEdi10AlojConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 8.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 7.11 - 8.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 4.75 - 7.11' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 2.38 - 4.75' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 2.38' + '<br>'
...
var legendaVar1AlojConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-21.62 a -10]' + '<br>'
...
var legendaVar2a4AlojConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-19.15 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar5a9AlojConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.02 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar10AlojConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]19.23 a 50]' + '<br>'
...
var legendaVar2a4AlojConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-23.44 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar5a9AlojConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]10 a 20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [6.16 a 10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar10AlojConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [7.32 a 20]' + '<br>'
...
var legendaVar1AlojConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 1.5' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-15.34 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2a4AlojConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-10.7 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar5a9AlojConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [0.46 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' 0' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar10AlojConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]6 a 10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]3 a 6]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [1.66 a 3]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPerEdi1AlojFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 91.37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 78.42 - 91.37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 56.84 - 78.42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 35.25 - 56.84' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 13.67 - 35.25' + '<br>'
...
var legendaPerEdi2a4AlojFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 29.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 24.61 - 29.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 16.41 - 24.61' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 8.2 - 16.41' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 8.2' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#506266"></i>' + ' 0' + '<br>'
...
var legendaPerEdi5a9AlojFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 18.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 15.38 - 18.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 10.26 - 15.38' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 5.13 - 10.26' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 5.13' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#506266"></i>' + ' 0' + '<br>'
...
var legendaPerEdi10AlojFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + ' > 11.23' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 9.36 - 11.23' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 6.24 - 9.36' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 3.12 - 6.24' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 3.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#506266"></i>' + ' 0' + '<br>'
...
var legendaVar1AlojFreg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-32.99 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar2a4AlojFreg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-91.67 a -50]' + '<br>'
...
var legendaVar1AlojFreg21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-28.11 a -10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar5a9AlojFreg21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-66.67 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#808080"></i>' + ' Cálculo não aplicável' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
