...
var legendaPercDensidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#0D0D0D"></i>' + '  > 500' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#400D01"></i>' + ' 250 a 500' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#8C2703"></i>' + ' 100 a 250' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D95204"></i>' + ' 50 a 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#F2A516"></i>' + ' 28.6 a 50' + '<br>'
...
var legendaVarDensidadeConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [8.41 a 12]' + '<br>'
...
var legendaPercDensidadeFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#400D01"></i>' + ' 250 a 500' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#8C2703"></i>' + ' 100 a 250' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D95204"></i>' + ' 20 a 100' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#F2A516"></i>' + ' 2 a 20' + '<br>'
