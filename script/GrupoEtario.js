...
function onEachFeaturePop25_64Conc11(feature, layer) {
    layer.bindPopup( 'Concelho: ' + '<b> ' + feature.properties.Concelho + '</b>' + ' <br> '  + 'Residentes com idade entre 25 e 64 anos: ' + '<b>' +feature.properties.F25_64_11 + '</b>').openPopup()
    layer.on({
        click: zoomToFeature,
        mouseover: hover, 
...
var legendaPer0_14Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 24.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 22.16 - 24.46' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 18.32 - 22.16' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 14.47 - 18.32' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 10.63 - 14.47' + '<br>'
...
var legendaPer15_24Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 20.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 18.32 - 20.12' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 15.31 - 18.32' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 12.31 - 15.31' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 9.3 - 12.31' + '<br>'
...
var legendaPer25_64Conc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 57.90' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 55.42 - 57.90' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 51.28 - 55.42' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 47.14 - 51.28' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 43 - 47.14' + '<br>'
...
var legendaVar0_14Conc91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-46.65 a -20]' + '<br>'
...
var legendaVar15_24Conc91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-20 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-42.77 a -20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#a6a6a6"></i>' + ' sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar25_64Conc91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]25 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-22.23 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#a6a6a6"></i>' + ' sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMais65_Conc91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]35 a 45]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 35]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-0.86 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#a6a6a6"></i>' + ' sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar0_14Conc01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-20 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-26.25 a -20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar15_24Conc01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]-20 a -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-25 a -20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-33.25 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar25_64Conc01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + '  ]> 11' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + '  ]8 a 11]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + '  ]4 a 8]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + '  ]0 a 4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + '  [-8 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMais65_Conc01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [2.78 a 10]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar0_14Conc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]> -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-20 a -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-23 a -20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-27.53 a -23]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar15_24Conc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]> 0' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-21.31 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar25_64Conc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-4 a -2.01]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-6 a -4]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-9 a -6]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-12.58 a -9]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMais65_Conc11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.33 a 20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPer0_14Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 24.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 21.6 - 24.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 16.37 - 21.6' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 11.13 - 16.37' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 5.9 - 11.13' + '<br>'
...
var legendaPer15_24Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 18.71' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 16.61 - 18.71' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 13.09 - 16.61' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 9.58 - 13.09' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 6.06 - 9.58' + '<br>'
...
var legendaPer25_64Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 58.78' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 55.97 - 58.78' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 51.3 - 55.97' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 46.62 - 51.3' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 41.94 - 46.62' + '<br>'
...
var legendaPerMais65Freg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 39.65' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 34.07 - 39.65' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 24.77 - 34.07' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 15.47 - 24.77' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 6.17 - 15.47' + '<br>'
...
var legendaVar0_14Freg01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-52.65 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar15_24Freg01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]> 0' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-25 a -15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-35 a -25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-71.43 a -35]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar25_64Freg01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-15 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-40.79 a -15]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMais65_Freg01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-26.36 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar0_14Freg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-35 a -20]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' [-59.26 a -35]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar15_24Freg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]> 15' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-10 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' ]-25 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' [-45 a -25]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVar25_64Freg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]> 0' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9ebbd7"></i>' + ' ]-10 a -5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + ' ]-20 a -10]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#155273"></i>' + ' ]-31.61 a -20]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarMais_65Freg11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]30 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-7.79 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
$('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 1991, por concelho.' + '</strong>')
...
let novaLayer = function(layer){
    ...
    if (layer == Pop15_24Conc91 && naoDuplicar != 2){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15-24 anos, em 1991, por concelho.' + '</strong>')
    ...
    if (layer == Pop25_64Conc91 && naoDuplicar != 3){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25-64 anos, em 1991, por concelho.' + '</strong>');
    ...
    if (layer == PopMais65Conc91 && naoDuplicar != 4){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 1991, por concelho.' + '</strong>');
    ...
    if (layer == Pop0_14Conc01 && naoDuplicar != 5){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == Pop15_24Conc01 && naoDuplicar != 6){
        $('#tituloMapa').html('<strong>' + 'Número de residentes em 2001 com idade entre 15 e 24 anos, por concelho.' + '</strong>');
    ...
    if (layer == Pop25_64Conc01 && naoDuplicar != 7){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == PopMais65Conc01 && naoDuplicar != 8){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2001, por concelho.' + '</strong>');
    ...
    if (layer == Pop0_14Conc11 && naoDuplicar != 9){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == Pop15_24Conc11 && naoDuplicar != 10){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15 e 24 anos, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == Pop25_64Conc11 && naoDuplicar != 11){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == PopMais65Conc11 && naoDuplicar != 12){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2011, por concelho.' + '</strong>');
    ...
    if (layer == Pop0_14Conc21 && naoDuplicar != 73){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == Pop15_24Conc21 && naoDuplicar != 74){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15 e 24 anos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == Pop25_64Conc21 && naoDuplicar != 75){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == PopMais65Conc21 && naoDuplicar != 76){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2021, por concelho.' + '</strong>');
    ...
    if (layer == Pop0_14Freg01 && naoDuplicar != 41){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2001, por freguesia.' + '</strong>');
    ...
    if (layer == Pop15_24Freg01 && naoDuplicar != 42){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15 e 24 anos, em 2001, por freguesia.' + '</strong>');
    ...
    if (layer == Pop25_64Freg01 && naoDuplicar != 43){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2001, por freguesia.' + '</strong>');
    ...
    if (layer == PopMais65Freg01 && naoDuplicar != 44){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2001, por freguesia.' + '</strong>');
    ...
    if (layer == Pop0_14Freg11 && naoDuplicar != 45){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2011, por freguesia.' + '</strong>');
    ...
    if (layer == Pop15_24Freg11 && naoDuplicar != 46){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15 e 24 anos, em 2011, por freguesia.' + '</strong>');
    ...
    if (layer == Pop25_64Freg11 && naoDuplicar != 47){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2011, por freguesia.' + '</strong>');
    ...
    if (layer == PopMais65Freg11 && naoDuplicar != 48){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2011, por freguesia.' + '</strong>');
    ...
    if (layer == Pop0_14Freg21 && naoDuplicar != 49){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 0 e 14 anos, em 2021, por freguesia.' + '</strong>');
    ...
    if (layer == Pop15_24Freg21 && naoDuplicar != 50){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 15 e 24 anos, em 2021, por freguesia.' + '</strong>');
    ...
    if (layer == Pop25_64Freg21 && naoDuplicar != 51){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade entre 25 e 64 anos, em 2021, por freguesia.' + '</strong>');
    ...
    if (layer == PopMais65Freg21 && naoDuplicar != 52){
        $('#tituloMapa').html('<strong>' + 'Número de residentes com idade superior a 65 anos, em 2021, por freguesia.' + '</strong>');
