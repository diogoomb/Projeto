...
var legendaVarTotAlojConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-3.08 a 0]' + '<br>'
...
var legendaVarTotAlojFamiConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-2.92 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]2 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 2]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-2.83 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojColetivosConc21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#2288bf"></i>' + '  [-61.9 a -40]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [8.14 a 12]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-18.28 a 0]' + '<br>'
...
var legendaVarTotAlojFamiConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]15 a 18]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]12 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [8.13 a 12]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamiConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-18.24 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' Sem informação disponível' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 18' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]15 a 18]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]12 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' [9.28 a 12]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#de1f35"></i>' + ' ]> 50' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ff5e6e"></i>' + ' ]40 a 50]' + '<br>'
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-18.17 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + '  Sem informação disponível' + '<br>'
...
var legendaVarTotAlojFamNaoClassConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-35.92 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + '  Sem informação disponível' + '<br>'
...
var legendaVarTotAlojColetivosConc11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-10.53 a 0]' + '<br>'
...
var legendaVarTotAlojColetivosConc01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 25]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-50 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-71.88 a -50]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + '  Sem informação disponível' + '<br>'
...
var legendaVarTotAlojFreg21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-12.26 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFreg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-13.66 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFreg01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-54.13 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamFreg21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-11.89 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamFreg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-13.53 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamFreg01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-54.11 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassFreg21_11 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 5]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' ]-5 a 0]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#9eaad7"></i>' + ' [-11.81 a -5]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassFreg11_01 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-12.93 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaVarTotAlojFamClassFreg01_91 = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#f5b3be"></i>' + ' ]15 a 30]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#fbcec6"></i>' + ' ]0 a 15]' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#ced4ea"></i>' + ' [-54.65 a 0]' + '<br>'
    $(symbolsContainer).css("opacity","0.8")
...
var legendaPerAlojaFamiliaresConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 99.92' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 99.83 - 99.92' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 99.70 - 99.83' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 99.56 - 99.70' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 99.42 - 99.56' + '<br>'
...
var legendaPerAlojaFamClassConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 99.89' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 99.73 - 99.89' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 99.47 - 99.73' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83 "></i>' + ' 99.2 - 99.47' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 98.93 - 99.2' + '<br>'
...
var legendaPerAlojaFamNaoClassConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 0.96' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 0.8 - 0.96' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 0.54 - 0.8' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 0.27 - 0.54' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 0.27' + '<br>'
...
var legendaPerAlojaFamColetivosConc = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 0.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 0.44 - 0.53' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 0.31 - 0.44' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 0.17 - 0.31' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.03 - 0.17' + '<br>'
...
var legendaPerAlojaFamiliaresFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 99.70' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 99.26 - 99.70' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 98.52 - 99.26' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 97.78 - 98.52' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 97.04 - 97.78' + '<br>'
...
var legendaPerAlojaFamiliaresClassFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 99.14' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 97.85 - 99.14' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 95.7 - 97.85' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 93.54 - 95.7' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 91.39 - 93.54' + '<br>'
...
var legendaPerAlojaFamiliaresNaoClassFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 7.72' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 6.44 - 7.72' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 4.29 - 6.44' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 2.15 - 4.29' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 2.15' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' 0' + '<br>'
...
var legendaPerAlojaFamiliaresColetivosFreg = function() {
    ...
    symbolsContainer.innerHTML +=  '<i style="background:#991101"></i>' + '  > 2.66' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#C23210"></i>' + ' 2.22 - 2.66' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#D65F59"></i>' + ' 1.48 - 2.22' + '<br>'   
    symbolsContainer.innerHTML +=  '<i style="background:#FF8A83"></i>' + ' 0.74 - 1.48' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#FFD0C2"></i>' + ' 0.01 - 0.74' + '<br>'
    symbolsContainer.innerHTML +=  '<i style="background:#000000"></i>' + ' 0' + '<br>'
